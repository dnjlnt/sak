...
class D0075 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0075_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $luka_opilsiotomi = $this->input->post("luka_opilsiotomi");
            $kontraksi_uterus = $this->input->post("kontraksi_uterus");
            ...
            $kontraksi_uterus_2 = $this->input->post("kontraksi_uterus_2");
            $payudara_membengkak = $this->input->post("payudara_membengkak");
            $tekanan_darah = $this->input->post("tekanan_darah");
            $frekuensi_nadi = $this->input->post("frekuensi_nadi");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0075($newDiagRecordNumber, $durasi_intervensi, $tidak_nyaman, $meringis, $luka_opilsiotomi, $kontraksi_uterus, $berkeringat, $menangis, $merintih, $haemoroid, $kontraksi_uterus_2, $payudara_membengkak, $tekanan_darah, $frekuensi_nadi, $created_by, $created_dttm);
