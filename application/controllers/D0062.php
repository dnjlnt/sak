...
class D0062 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0062_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$kemampuan_mempelajar_hal_baru = $this->input->post("kemampuan_mempelajar_hal_baru");
            $kemampuan_mengingat_informasi_faktual = $this->input->post("kemampuan_mengingat_informasi_faktual");
            $kemampuan_mengingat_perilaku = $this->input->post("kemampuan_mengingat_perilaku");
            $kemampuan_mengingat_peristiwa = $this->input->post("kemampuan_mengingat_peristiwa");
            $kemampuan_dipelajari = $this->input->post("kemampuan_dipelajari");
            $pengalaman_lupa = $this->input->post("pengalaman_lupa");
            $lupa_jadwal = $this->input->post("lupa_jadwal");
            $mudah_lupa = $this->input->post("mudah_lupa");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0062($newDiagRecordNumber, $durasi_intervensi, $kemampuan_mempelajar_hal_baru, $kemampuan_mengingat_informasi_faktual, $kemampuan_mengingat_perilaku, $kemampuan_mengingat_peristiwa, $kemampuan_dipelajari, $pengalaman_lupa, $lupa_jadwal, $mudah_lupa, $created_by, $created_dttm);
