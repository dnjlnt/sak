...
class D0017 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0017_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $tekanan_intra_kranial = $this->input->post("tekanan_intra_kranial");
            ...
            $refleks_sadar = $this->input->post("refleks_sadar");
           
            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0017($newDiagRecordNumber, $durasi_intervensi, $tingkat_kesadaran, $kognitif, $tekanan_intra_kranial, $sakit_kepala, $gelisah, $kecemasan, $agitasi, $demam, $tekanan_darah, $kesadaran, $tekanan_darah_sistolik, $tekanan_darah_diastolik, $created_by, $created_dttm);
