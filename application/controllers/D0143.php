...
class D0143 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0143_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$jatuh_tempat_tidur = $this->input->post("jatuh_tempat_tidur");
            $jatuh_saat_berdiri = $this->input->post("jatuh_saat_berdiri");
            $jatuh_saat_duduk = $this->input->post("jatuh_saat_duduk");
            $jatuh_saat_berjalan = $this->input->post("jatuh_saat_berjalan");
            $jatuh_saat_pindah = $this->input->post("jatuh_saat_pindah");
            $jatuh_naik_tangga = $this->input->post("jatuh_naik_tangga");
            $jatuh_kamar_mandi = $this->input->post("jatuh_kamar_mandi");
            $jatuh_saat_membungkuk = $this->input->post("jatuh_saat_membungkuk");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0143($newDiagRecordNumber, $durasi_intervensi, $jatuh_tempat_tidur, $jatuh_saat_berdiri, $jatuh_saat_duduk, $jatuh_saat_berjalan, $jatuh_saat_pindah, $jatuh_naik_tangga, $jatuh_kamar_mandi, $jatuh_saat_membungkuk, $created_by, $created_dttm);
