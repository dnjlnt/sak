...
class D0019 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0019_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $kekuatan_otot_pengunyah = $this->input->post("kekuatan_otot_pengunyah");
            $kekuatan_otot_menelan = $this->input->post("kekuatan_otot_menelan");
            $serum_albumin = $this->input->post("serum_albumin");
            $vebalisasi = $this->input->post("vebalisasi");
            $pengetahuan_makanan_sehat = $this->input->post("pengetahuan_makanan_sehat");
            $pengetahuan_asupan_nutrisi = $this->input->post("pengetahuan_asupan_nutrisi");
            ...
            $perasaan_cepat_kenyang = $this->input->post("perasaan_cepat_kenyang");
