...
class D0040 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0040_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$sensasi_berkemih = $this->input->post("sensasi_berkemih");
            $desakan_berkemih = $this->input->post("desakan_berkemih");
            $distensi_kandung_kemih = $this->input->post("distensi_kandung_kemih");
            $berkemih_tidak_tuntas = $this->input->post("berkemih_tidak_tuntas");
            $volume_residu_urine = $this->input->post("volume_residu_urine");
            $urine_menetas = $this->input->post("urine_menetas");
            $nokturia = $this->input->post("nokturia");
            $mengompol = $this->input->post("mengompol");
            $disuria = $this->input->post("disuria");
            $anuria = $this->input->post("anuria");
            $frekuensi_bak = $this->input->post("frekuensi_bak");
            $karakteristik_urine = $this->input->post("karakteristik_urine");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0040($newDiagRecordNumber, $durasi_intervensi, $sensasi_berkemih, $desakan_berkemih, $distensi_kandung_kemih, $berkemih_tidak_tuntas, $volume_residu_urine, $urine_menetas, $nokturia, $mengompol, $disuria, $anuria, $frekuensi_bak, $karakteristik_urine, $created_by, $created_dttm);
