...
class D0056 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0056_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $kemudahan_beraktivitas = $this->input->post("kemudahan_beraktivitas");
            $kecepatan_berjalan = $this->input->post("kecepatan_berjalan");
            $jarak_berjalan = $this->input->post("jarak_berjalan");
            $kekuatan_tubuh_atas = $this->input->post("kekuatan_tubuh_atas");
            $kekuatan_tubuh_bawah = $this->input->post("kekuatan_tubuh_bawah");
            $toleransi_menaiki_tangga = $this->input->post("toleransi_menaiki_tangga");
            $keluhan_lelah = $this->input->post("keluhan_lelah");
            $dispnea = $this->input->post("dispnea");
            $perasaan_lemah = $this->input->post("perasaan_lemah");
            $aritmia_saat_aktivitas = $this->input->post("aritmia_saat_aktivitas");
            $aritmia_setelah_aktivitas = $this->input->post("aritmia_setelah_aktivitas");
            $warna_kulit = $this->input->post("warna_kulit");
            $tekanan_darah = $this->input->post("tekanan_darah");
            $frekuensi_nafas = $this->input->post("frekuensi_nafas");
            $ekg_iskemia = $this->input->post("ekg_iskemia");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0056($newDiagRecordNumber, $durasi_intervensi, $frekuensi_nadi, $saturasi_oksigen, $kemudahan_beraktivitas, $kecepatan_berjalan, $jarak_berjalan, $kekuatan_tubuh_atas, $kekuatan_tubuh_bawah, $toleransi_menaiki_tangga, $keluhan_lelah, $dispnea, $perasaan_lemah, $aritmia_saat_aktivitas, $aritmia_setelah_aktivitas, $warna_kulit, $tekanan_darah, $frekuensi_nafas, $ekg_iskemia, $created_by, $created_dttm);
