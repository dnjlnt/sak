...
class D0023 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0023_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$kekuatan_nadi = $this->input->post("kekuatan_nadi");
            $turgor_kulit = $this->input->post("turgor_kulit");
            $output_urine = $this->input->post("output_urine");
            $pengisian_vena = $this->input->post("pengisian_vena");
            $ortopnea = $this->input->post("ortopnea");
            $dispnea = $this->input->post("dispnea");
            $pnd = $this->input->post("pnd");
            $edema_anasarka = $this->input->post("edema_anasarka");
            $edema_perifer = $this->input->post("edema_perifer");
