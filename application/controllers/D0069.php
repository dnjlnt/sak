...
class D0069 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0069_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$kepuasan_hubungan = $this->input->post("kepuasan_hubungan");
            $informasi_kepuasan = $this->input->post("informasi_kepuasan");
            $aktivitas_seks_berubah = $this->input->post("aktivitas_seks_berubah");
            $eksistasi_seks_berubah = $this->input->post("eksistasi_seks_berubah");
            $peran_seks_berubah = $this->input->post("peran_seks_berubah");
            $fungsi_seks_berubah = $this->input->post("fungsi_seks_berubah");
            $dispareunia = $this->input->post("dispareunia");
            $keluhan_seks_terbatas = $this->input->post("keluhan_seks_terbatas");
            $keluhan_sulit_seks = $this->input->post("keluhan_sulit_seks");
            $perilaku_seks_berubah = $this->input->post("perilaku_seks_berubah");
            $konflik_nilai = $this->input->post("konflik_nilai");
            $hasrat_seksual = $this->input->post("hasrat_seksual");
            $orientasi_seksual = $this->input->post("orientasi_seksual");
            $ketertarikan_pasangan = $this->input->post("ketertarikan_pasangan");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0069($newDiagRecordNumber, $durasi_intervensi, $kepuasan_hubungan, $informasi_kepuasan, $aktivitas_seks_berubah, $eksistasi_seks_berubah, $peran_seks_berubah, $fungsi_seks_berubah, $dispareunia, $keluhan_seks_terbatas, $keluhan_sulit_seks, $perilaku_seks_berubah, $konflik_nilai, $hasrat_seksual, $orientasi_seksual, $ketertarikan_pasangan, $created_by, $created_dttm);
