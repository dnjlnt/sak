...
class I_01006 extends CI_Controller {
	...
	public function index() {
        ...
        $this->load->view('intervensi/I_01006.php', $data);
	}
    ...
    public function saveIntervensi() {
        ...
        // print_r($selectedIntervensiObservasi);
        // print_r($selectedIntervensiTerapeutik);
        // print_r($selectedIntervensiEdukasi);
        // print_r($selectedIntervensiKolaborasi);
