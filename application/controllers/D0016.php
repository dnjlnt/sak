...
class D0016 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0016_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $kadar_urea_nitrogen_darah = $this->input->post("kadar_urea_nitrogen_darah");
            $kadar_kreatinin_plasma = $this->input->post("kadar_kreatinin_plasma");
