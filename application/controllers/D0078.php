...
class D0078 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0078_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$menuntaskan_aktivitas = $this->input->post("menuntaskan_aktivitas");
            $keluhan_nyeri = $this->input->post("keluhan_nyeri");
            $meringis = $this->input->post("meringis");
            $sikap_protektif = $this->input->post("sikap_protektif");
            $gelisah = $this->input->post("gelisah");
            $kesulitan_tidur = $this->input->post("kesulitan_tidur");
            $menarik_diri = $this->input->post("menarik_diri");
            $fokus_diri_sendiri = $this->input->post("fokus_diri_sendiri");
            $diaforesis = $this->input->post("diaforesis");
            $depresi = $this->input->post("depresi");
            $cedera_berulang = $this->input->post("cedera_berulang");
            $anoreksia = $this->input->post("anoreksia");
            $perineum_tertekan = $this->input->post("perineum_tertekan");
            $uterus_membulat = $this->input->post("uterus_membulat");
            $ketegangan_otot = $this->input->post("ketegangan_otot");
            $pupil_dilatasi = $this->input->post("pupil_dilatasi");
