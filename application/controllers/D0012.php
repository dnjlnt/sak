...
class D0012 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0012_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$membran_mukosa_lembab = $this->input->post("membran_mukosa_lembab");
            $kelembaban_kulit = $this->input->post("kelembaban_kulit");
            $kognitif = $this->input->post("kognitif");
            $hemoptisis = $this->input->post("hemoptisis");
            $hematemesis = $this->input->post("hematemesis");
            $hematuria = $this->input->post("hematuria");
            $pendarahan_anus = $this->input->post("pendarahan_anus");
            $distensi_abdomen = $this->input->post("distensi_abdomen");
            $pendarahan_pervagina = $this->input->post("pendarahan_pervagina");
