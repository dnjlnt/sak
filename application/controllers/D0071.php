...
class D0071 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0071_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$pendirian_seks_jelas = $this->input->post("pendirian_seks_jelas");
            $integrasi_orientasi_seks = $this->input->post("integrasi_orientasi_seks");
            $batasan_jenis_kelamin = $this->input->post("batasan_jenis_kelamin");
            $dukungan_sosial = $this->input->post("dukungan_sosial");
            $hubungan_harmonis = $this->input->post("hubungan_harmonis");
            $hubungan_seks_sehat = $this->input->post("hubungan_seks_sehat");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0071($newDiagRecordNumber, $durasi_intervensi, $pendirian_seks_jelas, $integrasi_orientasi_seks, $batasan_jenis_kelamin, $dukungan_sosial, $hubungan_harmonis, $hubungan_seks_sehat, $created_by, $created_dttm);
