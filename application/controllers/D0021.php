...
class D0021 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0021_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $suara_peristaltik = $this->input->post("suara_peristaltik");
            $pengosongan_lambung = $this->input->post("pengosongan_lambung");
            $flatus = $this->input->post("flatus");
            ...
            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0021($newDiagRecordNumber, $durasi_intervensi, $nyeri, $kram_abdomen, $mual, $muntah, $regurgitasi, $distensi_abdomen, $diare, $suara_peristaltik, $pengosongan_lambung, $flatus, $konsistensi_feses, $frekuensi_defekasi, $peristaltik_usus, $created_by, $created_dttm);
