...
class D0003 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0003_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $bunyi_nafas_tambahan = $this->input->post("bunyi_nafas_tambahan");
            $pusing = $this->input->post("pusing");
            $penglihatan_kabur = $this->input->post("penglihatan_kabur");
            $diaforesis = $this->input->post("diaforesis");
            $gelisah = $this->input->post("gelisah");
            $nafas_cuping_hidung = $this->input->post("nafas_cuping_hidung");
            $pco2 = $this->input->post("pco2");
            $po2 = $this->input->post("po2");
            $takikardia = $this->input->post("takikardia");
            $ph_arteri = $this->input->post("ph_arteri");
            $sianosis = $this->input->post("sianosis");
            $pola_nafas = $this->input->post("pola_nafas");
            $warna_kulit = $this->input->post("warna_kulit");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0003($newDiagRecordNumber, $durasi_intervensi, $tingkat_kesadaran, $dispnea, $bunyi_nafas_tambahan, $pusing, $penglihatan_kabur, $diaforesis, $gelisah, $nafas_cuping_hidung, $pco2, $po2, $takikardia, $ph_arteri, $sianosis, $pola_nafas, $warna_kulit, $created_by, $created_dttm);
