...
class D0111 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0111_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$perilaku_sesuai_anjuran = $this->input->post("perilaku_sesuai_anjuran");
            $minat_catatan_belajar = $this->input->post("minat_catatan_belajar");
            $menjelaskan_pengetahuan = $this->input->post("menjelaskan_pengetahuan");
            $menggambarkan_pengalaman = $this->input->post("menggambarkan_pengalaman");
            $perilaku_sesuai_pengetahuan = $this->input->post("perilaku_sesuai_pengetahuan");
            $pertanyaan_masalah = $this->input->post("pertanyaan_masalah");
            $persepi_keliru = $this->input->post("persepi_keliru");
            $pemeriksaan_kurang_tepat = $this->input->post("pemeriksaan_kurang_tepat");
            $perilaku = $this->input->post("perilaku");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0111($newDiagRecordNumber, $durasi_intervensi, $perilaku_sesuai_anjuran, $minat_catatan_belajar, $menjelaskan_pengetahuan, $menggambarkan_pengalaman, $perilaku_sesuai_pengetahuan, $pertanyaan_masalah, $persepi_keliru, $pemeriksaan_kurang_tepat, $perilaku, $created_by, $created_dttm);
