...
class D0055 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0055_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $sering_terjaga = $this->input->post("sering_terjaga");
            $tidak_puas_tidur = $this->input->post("tidak_puas_tidur");
            $pola_tidur_berubah = $this->input->post("pola_tidur_berubah");
            $istirahat_tidak_cukup = $this->input->post("istirahat_tidak_cukup");
            $kemampuan_beraktivitas = $this->input->post("kemampuan_beraktivitas");
            $kemampuan_beraktivitas_2 = $this->input->post("kemampuan_beraktivitas_2");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0055($newDiagRecordNumber, $durasi_intervensi, $sulit_tidur, $sering_terjaga, $tidak_puas_tidur, $pola_tidur_berubah, $istirahat_tidak_cukup, $kemampuan_beraktivitas, $kemampuan_beraktivitas_2, $created_by, $created_dttm);
