...
class D0039 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0039_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $kerusakan_lapisan = $this->input->post("kerusakan_lapisan");
            ...
            $jaringan_perut = $this->input->post("jaringan_perut");
