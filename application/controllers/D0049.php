...
class D0049 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0049_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$pengeluaran_feses = $this->input->post("pengeluaran_feses");
            ...
            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0049($newDiagRecordNumber, $durasi_intervensi, $pengeluaran_feses, $keluhan_defekasi, $mengejan, $distensi_abdomen, $teraba_massa, $urgency, $nyeri_abdomen, $kram_abdomen, $konsistensi_feses, $frekuensi_defekasi, $peristaltik_usus, $created_by, $created_dttm);
