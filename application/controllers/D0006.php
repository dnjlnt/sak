...
class D0006 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0006_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $kemampuan_menelan = $this->input->post("kemampuan_menelan");
            ...
            $akumulasi_sekret = $this->input->post("akumulasi_sekret");
            $wheezing = $this->input->post("wheezing");
            $batuk = $this->input->post("batuk");
            $otot_asesoris = $this->input->post("otot_asesoris");
            $gelisah = $this->input->post("gelisah");
            $frekuensi_nafas = $this->input->post("frekuensi_nafas");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0006($newDiagRecordNumber, $durasi_intervensi, $tingkat_kesadaran, $kemampuan_menelan, $kebersihan_mulut, $dispnea, $kelemahan_otot, $akumulasi_sekret, $wheezing, $batuk, $otot_asesoris, $gelisah, $frekuensi_nafas, $created_by, $created_dttm);
