...
class D0036 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0036_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$asupan_cairan = $this->input->post("asupan_cairan");
            $haluaran_urin = $this->input->post("haluaran_urin");
            $kelembaban_membran = $this->input->post("kelembaban_membran");
            $asupan_makanan = $this->input->post("asupan_makanan");
            $edema = $this->input->post("edema");
            $dehidrasi = $this->input->post("dehidrasi");
            ...
            $mata_cekung = $this->input->post("mata_cekung");
            $turgor_kulit = $this->input->post("turgor_kulit");
            $berat_badan = $this->input->post("berat_badan");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0036($newDiagRecordNumber, $durasi_intervensi, $asupan_cairan, $haluaran_urin, $kelembaban_membran, $asupan_makanan, $edema, $dehidrasi, $asites, $konfusi, $tekanan_darah, $denyut_nadi_radial, $tekanan_arteri, $membran_mukosa, $mata_cekung, $turgor_kulit, $berat_badan, $created_by, $created_dttm);
