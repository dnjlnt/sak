...
class D0018 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0018_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0018($newDiagRecordNumber, $durasi_intervensi, $berat_badan, $tebal_lipatan_kulit, $index_massa_tubuh, $created_by, $created_dttm);
