...
class D0106 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0106_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $respon_sosial = $this->input->post("respon_sosial");
            $kontak_mata = $this->input->post("kontak_mata");
            $bb_sesuai_usia = $this->input->post("bb_sesuai_usia");
            $panjang_tinggi_badan = $this->input->post("panjang_tinggi_badan");
            $lingkar_kepala = $this->input->post("lingkar_kepala");
            $kecepatan_tambah_bb = $this->input->post("kecepatan_tambah_bb");
            $kecepatan_tambah_tb = $this->input->post("kecepatan_tambah_tb");
            $index_massa_tubuh = $this->input->post("index_massa_tubuh");
            $asupan_nutrisi = $this->input->post("asupan_nutrisi");
            $kemarahan = $this->input->post("kemarahan");
            $regresi = $this->input->post("regresi");
            $afek = $this->input->post("afek");
            $pola_tidur = $this->input->post("pola_tidur");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0106($newDiagRecordNumber, $durasi_intervensi, $perilaku_sesuai_usia, $perawatan_diri, $respon_sosial, $kontak_mata, $bb_sesuai_usia, $panjang_tinggi_badan, $lingkar_kepala, $kecepatan_tambah_bb, $kecepatan_tambah_tb, $index_massa_tubuh, $asupan_nutrisi, $kemarahan, $regresi, $afek, $pola_tidur, $created_by, $created_dttm);
