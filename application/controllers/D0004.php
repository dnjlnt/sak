...
class D0004 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0004_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$volume_tidal = $this->input->post("volume_tidal");
            ...
            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0004($newDiagRecordNumber, $durasi_intervensi, $volume_tidal, $dispnea, $otot_bantu_nafas, $gelisah, $pco2, $po2, $so2, $takikardia, $created_by, $created_dttm);
