...
class D0014 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0014_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $diaforesis = $this->input->post("diaforesis");
            $mual = $this->input->post("mual");
            $muntah = $this->input->post("muntah");
            $arteri_apikal = $this->input->post("arteri_apikal");
            $tekanan_arteri = $this->input->post("tekanan_arteri");
            $takikardia = $this->input->post("takikardia");
            $bradikardia = $this->input->post("bradikardia");
            $denyut_nadi_radial = $this->input->post("denyut_nadi_radial");
            $tekanan_darah_fraksi_ejeksi = $this->input->post("tekanan_darah_fraksi_ejeksi");
            $tekanan_baji_arteri_pulmonal = $this->input->post("tekanan_baji_arteri_pulmonal");
            $cardiac_index = $this->input->post("cardiac_index");
            
            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0014($newDiagRecordNumber, $durasi_intervensi, $ekg_aritmia, $nyeri_dada, $diaforesis, $mual, $muntah, $arteri_apikal, $tekanan_arteri, $takikardia, $bradikardia, $denyut_nadi_radial, $tekanan_darah_fraksi_ejeksi, $tekanan_baji_arteri_pulmonal, $cardiac_index, $created_by, $created_dttm);
