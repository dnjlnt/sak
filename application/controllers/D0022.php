...
class D0022 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0022_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $keluaran_urine = $this->input->post("keluaran_urine");
            $kelembaban_membran_mukrosa = $this->input->post("kelembaban_membran_mukrosa");
