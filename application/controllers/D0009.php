...
class D0009 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0009_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$denyut_nadi_perifer = $this->input->post("denyut_nadi_perifer");
            $penyembuhan_luka = $this->input->post("penyembuhan_luka");
            $sensasi = $this->input->post("sensasi");
            $warna_kulit_pucat = $this->input->post("warna_kulit_pucat");
            $edema_perifer = $this->input->post("edema_perifer");
            $nyeri_ekstremitas = $this->input->post("nyeri_ekstremitas");
            $parastesia = $this->input->post("parastesia");
            $kelemahan_otot = $this->input->post("kelemahan_otot");
            $bruit_femoralis = $this->input->post("bruit_femoralis");
            $nekrosis = $this->input->post("nekrosis");
