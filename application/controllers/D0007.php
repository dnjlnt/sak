...
class D0007 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0007_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0007($newDiagRecordNumber, $durasi_intervensi, $tingkat_kesadaran, $frekuensi_nadi, $tekanan_darah, $frekuensi_napas, $suhu_tubuh, $saturasi_oksigen, $ekg_aritmia, $etco2, $produksi_urine, $created_by, $created_dttm);
