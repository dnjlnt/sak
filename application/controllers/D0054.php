...
class D0054 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0054_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$pergerakan_ekstremitas = $this->input->post("pergerakan_ekstremitas");
            ...
            $kaku_sendi = $this->input->post("kaku_sendi");
            $gerakan = $this->input->post("gerakan");
            $gerakan_terbatas = $this->input->post("gerakan_terbatas");
            $kelemahan_fisik = $this->input->post("kelemahan_fisik");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0054($newDiagRecordNumber, $durasi_intervensi, $pergerakan_ekstremitas, $kekuatan_otot, $rom, $nyeri, $kecemasan, $kaku_sendi, $gerakan, $gerakan_terbatas, $kelemahan_fisik, $created_by, $created_dttm);
