...
class D0011 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0011_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$kekuatan_nadi_perifer = $this->input->post("kekuatan_nadi_perifer");
            $ejection_fraction = $this->input->post("ejection_fraction");
            $cardiac_index = $this->input->post("cardiac_index");
            $lvswi = $this->input->post("lvswi");
            $svi = $this->input->post("svi");
            $palpitasi = $this->input->post("palpitasi");
            $bradikardia = $this->input->post("bradikardia");
            $takikardia = $this->input->post("takikardia");
            $ekg_aritmia = $this->input->post("ekg_aritmia");
            $lelah = $this->input->post("lelah");
            $edema = $this->input->post("edema");
            $distensi_vena_jugularis = $this->input->post("distensi_vena_jugularis");
            $dispnea = $this->input->post("dispnea");
            $ologouria = $this->input->post("ologouria");
            $pucat = $this->input->post("pucat");
            $pnd = $this->input->post("pnd");
            $ortopnea = $this->input->post("ortopnea");
            $batuk = $this->input->post("batuk");
            $suara_jantung_s3 = $this->input->post("suara_jantung_s3");
            $suara_jantung_s4 = $this->input->post("suara_jantung_s4");
            $murmur_jantung = $this->input->post("murmur_jantung");
            $berat_badan = $this->input->post("berat_badan");
            $hepatomegali = $this->input->post("hepatomegali");
            $pvr = $this->input->post("pvr");
            $svr = $this->input->post("svr");
            $tekanan_darah = $this->input->post("tekanan_darah");
            $crt = $this->input->post("crt");
            $pawp = $this->input->post("pawp");
            $cvp = $this->input->post("cvp");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0011($newDiagRecordNumber, $durasi_intervensi, $kekuatan_nadi_perifer, $ejection_fraction, $cardiac_index, $lvswi, $svi, $palpitasi, $bradikardia, $takikardia, $ekg_aritmia, $lelah, $edema, $distensi_vena_jugularis, $dispnea, $ologouria, $pucat, $pnd, $ortopnea, $batuk, $suara_jantung_s3, $suara_jantung_s4, $murmur_jantung, $berat_badan, $hepatomegali, $pvr, $svr, $tekanan_darah, $crt, $pawp, $cvp, $created_by, $created_dttm);
