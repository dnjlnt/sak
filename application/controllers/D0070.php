...
class D0070 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0070_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$kelekatan_emosional = $this->input->post("kelekatan_emosional");
            $koping = $this->input->post("koping");
            ...
            $nyeri_epigastrik = $this->input->post("nyeri_epigastrik");
            ...
            $mood_labil = $this->input->post("mood_labil");
            $protein_urine = $this->input->post("protein_urine");
            $glukosa_urine = $this->input->post("glukosa_urine");
            $glukosa_darah = $this->input->post("glukosa_darah");
            $berat_badan = $this->input->post("berat_badan");
            $tekanan_darah = $this->input->post("tekanan_darah");
            $hemoglobin = $this->input->post("hemoglobin");
            $refleks_neurologis = $this->input->post("refleks_neurologis");
