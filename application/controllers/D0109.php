...
class D0109 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0109_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$kemampuan_mandi = $this->input->post("kemampuan_mandi");
            $kemampuan_pakaian = $this->input->post("kemampuan_pakaian");
            $kemampuan_makan = $this->input->post("kemampuan_makan");
            $kemampuan_toilet = $this->input->post("kemampuan_toilet");
            $perawatan_diri = $this->input->post("perawatan_diri");
            $minat_perawatan_diri = $this->input->post("minat_perawatan_diri");
            $kebersihan_diri = $this->input->post("kebersihan_diri");
            $kebersihan_mulut = $this->input->post("kebersihan_mulut");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0109($newDiagRecordNumber, $durasi_intervensi, $kemampuan_mandi, $kemampuan_pakaian, $kemampuan_makan, $kemampuan_toilet, $perawatan_diri, $minat_perawatan_diri, $kebersihan_diri, $kebersihan_mulut, $created_by, $created_dttm);
