...
class D0008 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0008_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$nadi_perifer = $this->input->post("nadi_perifer");
            ...
            $olgouria = $this->input->post("olgouria");
