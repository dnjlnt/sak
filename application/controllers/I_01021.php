...
class I_01021 extends CI_Controller {
	...
	public function index() {
        ...
        $this->load->view('intervensi/I_01021.php', $data);
	}
    ...
    public function saveIntervensi() {
        ...
        if (count($selectedIntervensiObservasi) > 0 || $selectedIntervensiObservasi !== "") {
            foreach ($selectedIntervensiObservasi as $rowObs) {
                $saveProcess = $this->ModelIntervensi->saveIntervensi($rowObs, $master_diag_record_number, $int_record_id, $created_by, $created_dttm);
            }
        }
