...
class D0148 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0148_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0148($newDiagRecordNumber, $durasi_intervensi, $menggigil, $kulit_merah, $kejang, $akrosianosis, $konsumsi_oksigen, $piloereksi, $vasokonstriksi_perifer, $kutis_memorata, $pucat, $takikardi, $takipnea, $bradikardi, $dasar_kuku_sianotik, $hipoksia, $suhu_tubuh, $suhu_tubuh, $glukosa_darah, $pengisian_kapiler, $ventilasi, $tekanan_darah, $created_by, $created_dttm);
