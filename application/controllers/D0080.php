...
class D0080 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0080_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$kebingungan = $this->input->post("kebingungan");
            $khawatir = $this->input->post("khawatir");
            $perilaku_gelisah = $this->input->post("perilaku_gelisah");
            $perilaku_tegang = $this->input->post("perilaku_tegang");
