...
class D0030 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0030_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0030($newDiagRecordNumber, $durasi_intervensi, $berat_badan, $tebal_lipatan_kulit, $index_massa_tubuh, $created_by, $created_dttm);
