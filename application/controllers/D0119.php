...
class D0119 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0119_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$kemampuan_berbicara = $this->input->post("kemampuan_berbicara");
            $kemampuan_mendengar = $this->input->post("kemampuan_mendengar");
            $kesesuaian_ekspresi = $this->input->post("kesesuaian_ekspresi");
            $kontak_mata = $this->input->post("kontak_mata");
            $afasia = $this->input->post("afasia");
            $disfasia = $this->input->post("disfasia");
            $apraksia = $this->input->post("apraksia");
            $disleksia = $this->input->post("disleksia");
            $disartria = $this->input->post("disartria");
            $afonia = $this->input->post("afonia");
            $dislalia = $this->input->post("dislalia");
            $pelo = $this->input->post("pelo");
            $gagap = $this->input->post("gagap");
            $repson_perilaku = $this->input->post("repson_perilaku");
            $pemahaman_komunikasi = $this->input->post("pemahaman_komunikasi");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0119($newDiagRecordNumber, $durasi_intervensi, $kemampuan_berbicara, $kemampuan_mendengar, $kesesuaian_ekspresi, $kontak_mata, $afasia, $disfasia, $apraksia, $disleksia, $disartria, $afonia, $dislalia, $pelo, $gagap, $repson_perilaku, $pemahaman_komunikasi, $created_by, $created_dttm);
