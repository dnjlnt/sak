...
class D0020 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0020_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$kontrol_pengeluaran_feses = $this->input->post("kontrol_pengeluaran_feses");
            $keluhan_defekasi = $this->input->post("keluhan_defekasi");
            $mengejan = $this->input->post("mengejan");
            $distensi_abdomen = $this->input->post("distensi_abdomen");
            $teraba_massa = $this->input->post("teraba_massa");
            $urgency = $this->input->post("urgency");
            $nyeri_abdomen = $this->input->post("nyeri_abdomen");
            $kram_abdomen = $this->input->post("kram_abdomen");
            $konsistensi_feses = $this->input->post("konsistensi_feses");
            $frekuensi_defekasi = $this->input->post("frekuensi_defekasi");
            $peristaltik_usus = $this->input->post("peristaltik_usus");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0020($newDiagRecordNumber, $durasi_intervensi, $kontrol_pengeluaran_feses, $keluhan_defekasi, $mengejan, $distensi_abdomen, $teraba_massa, $urgency, $nyeri_abdomen, $kram_abdomen, $konsistensi_feses, $frekuensi_defekasi, $peristaltik_usus, $created_by, $created_dttm);
