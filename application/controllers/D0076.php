...
class D0076 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0076_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $keluhan_mual = $this->input->post("keluhan_mual");
            $ingin_muntah = $this->input->post("ingin_muntah");
            $asam_mulut = $this->input->post("asam_mulut");
            $sensasi_panas = $this->input->post("sensasi_panas");
            $sensasi_dingin = $this->input->post("sensasi_dingin");
            $frekuensi_menelan = $this->input->post("frekuensi_menelan");
            $diafroresis = $this->input->post("diafroresis");
            $jumlah_saliva = $this->input->post("jumlah_saliva");
            $pucat = $this->input->post("pucat");
            $takikardi = $this->input->post("takikardi");
            $dilatasi_pupil = $this->input->post("dilatasi_pupil");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0076($newDiagRecordNumber, $durasi_intervensi, $nafsu_makan, $keluhan_mual, $ingin_muntah, $asam_mulut, $sensasi_panas, $sensasi_dingin, $frekuensi_menelan, $diafroresis, $jumlah_saliva, $pucat, $takikardi, $dilatasi_pupil, $created_by, $created_dttm);
