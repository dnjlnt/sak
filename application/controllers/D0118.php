...
class D0118 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0118_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
			...
			$nyaman_situasi_sosial = $this->input->post("nyaman_situasi_sosial");
            $mudah_menerima = $this->input->post("mudah_menerima");
            $responsif = $this->input->post("responsif");
            $perasaan_tertarik = $this->input->post("perasaan_tertarik");
            $minat_kontak_emosi = $this->input->post("minat_kontak_emosi");
            $minat_kontak_fisik = $this->input->post("minat_kontak_fisik");
            $kasih_sayang = $this->input->post("kasih_sayang");
            $kontak_mata = $this->input->post("kontak_mata");
            $ekspresi_wajah = $this->input->post("ekspresi_wajah");
            $kooperatif_bermain = $this->input->post("kooperatif_bermain");
            $perilaku_sesuai_usia = $this->input->post("perilaku_sesuai_usia");
            $gejala_cemas = $this->input->post("gejala_cemas");

            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0118($newDiagRecordNumber, $durasi_intervensi, $nyaman_situasi_sosial, $mudah_menerima, $responsif, $perasaan_tertarik, $minat_kontak_emosi, $minat_kontak_fisik, $kasih_sayang, $kontak_mata, $ekspresi_wajah, $kooperatif_bermain, $perilaku_sesuai_usia, $gejala_cemas, $created_by, $created_dttm);
