...
class D0013 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('diagnosa/form/d0013_form.php', $data);
	}
	...
	public function saveNewDiagnosa() {
		...
		if ($saveMasterDiagRecord == true) {
            ...
            $saveLuaranKeperawatan = $this->ModelDiagnosa->saveLuaranKeperawatand0013($newDiagRecordNumber, $durasi_intervensi, $nafsu_makan, $mual, $muntah, $nyeri_abdomen, $asites, $konstipasi, $diare, $bising_usus, $created_by, $created_dttm);
