...
<html lang="en">
	...
	<body >
        ...
        <script type="text/javascript">
            ...
            function savemanajamennafas(master_diag_record_number, int_record_id) {
                var selectedIntervensi = new Array();
                $('input[name="int_manjalannafas"]:checked').each(function() {
                    selectedIntervensi.push(this.value);
                });

                $.ajax({
                    type: "post",
                    url: "<?php echo base_url();?>intervensi/savemanajemenjalannafas",
