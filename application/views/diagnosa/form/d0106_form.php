	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Keterampilan/Perilaku Sesuai Usia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="perilaku_sesuai_usia">
                                                                ...
                                                                <label class="form-label">Kemampuan Melakukan Perawatan Diri</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Respon Sosial</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="respon_sosial">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">BB Sesuai Usia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="bb_sesuai_usia">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Panjang/Tinggi Badan Sesuai Usia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="panjang_tinggi_badan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="lingkar_kepala">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kecepatan Bertambah BB</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kecepatan_tambah_bb">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kecepatan Bertambah TB</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kecepatan_tambah_tb">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Asupan Nutrisi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="asupan_nutrisi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kemarahan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemarahan">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Regresi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="regresi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Afek</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="afek">
                                                                        <option value="0">Tidak Ada</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var perilaku_sesuai_usia = $("#perilaku_sesuai_usia").val();
                var perawatan_diri = $("#perawatan_diri").val();
                var respon_sosial = $("#respon_sosial").val();
                var kontak_mata = $("#kontak_mata").val();
                var bb_sesuai_usia = $("#bb_sesuai_usia").val();
                var panjang_tinggi_badan = $("#panjang_tinggi_badan").val();
                var lingkar_kepala = $("#lingkar_kepala").val();
                var kecepatan_tambah_bb = $("#kecepatan_tambah_bb").val();
                var kecepatan_tambah_tb = $("#kecepatan_tambah_tb").val();
                var index_massa_tubuh = $("#index_massa_tubuh").val();
                var asupan_nutrisi = $("#asupan_nutrisi").val();
                var kemarahan = $("#kemarahan").val();
                var regresi = $("#regresi").val();
                var afek = $("#afek").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, selectedIntervensiUtama:selectedIntervensiUtama, selectedIntervensiPendukung:selectedIntervensiPendukung, durasi_intervensi:durasi_intervensi, perilaku_sesuai_usia:perilaku_sesuai_usia, perawatan_diri:perawatan_diri, respon_sosial:respon_sosial, kontak_mata:kontak_mata, bb_sesuai_usia:bb_sesuai_usia, panjang_tinggi_badan:panjang_tinggi_badan, lingkar_kepala:lingkar_kepala, kecepatan_tambah_bb:kecepatan_tambah_bb, kecepatan_tambah_tb:kecepatan_tambah_tb, index_massa_tubuh:index_massa_tubuh, asupan_nutrisi:asupan_nutrisi, kemarahan:kemarahan, regresi:regresi, afek:afek, pola_tidur:pola_tidur, master_form_diagnosa:master_form_diagnosa},
