	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Pergerakan Ekstremitas</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pergerakan_ekstremitas">
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kekuatan_otot">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Rentang Gerak (ROM)</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Kecemasan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kecemasan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kaku Sendi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kaku_sendi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Gerakan Tidak Terkoordinasi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="gerakan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Gerakan Terbatas</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="gerakan_terbatas">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kelemahan Fisik</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kelemahan_fisik">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var pergerakan_ekstremitas = $("#pergerakan_ekstremitas").val();
                var kekuatan_otot = $("#kekuatan_otot").val();
                var rom = $("#rom").val();
                var nyeri = $("#nyeri").val();
                var kecemasan = $("#kecemasan").val();
                var kaku_sendi = $("#kaku_sendi").val();
                var gerakan = $("#gerakan").val();
                var gerakan_terbatas = $("#gerakan_terbatas").val();
                var kelemahan_fisik = $("#kelemahan_fisik").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, pergerakan_ekstremitas:pergerakan_ekstremitas, kekuatan_otot:kekuatan_otot, 
                           rom:rom, nyeri:nyeri, kecemasan:kecemasan, kaku_sendi:kaku_sendi, gerakan:gerakan, gerakan_terbatas:gerakan_terbatas, 
                           kelemahan_fisik:kelemahan_fisik, master_form_diagnosa:master_form_diagnosa},
