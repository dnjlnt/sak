            ...
            function saveDiagnosa() {
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, perlekatan_bayi:perlekatan_bayi, kemampuan_ibu:kemampuan_ibu, 
                           miksi_bayi:miksi_bayi, berat_badan_bayi:berat_badan_bayi, tetesan_asi:tetesan_asi, suplai_asi:suplai_asi, 
