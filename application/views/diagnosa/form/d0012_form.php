	...
	<body >
                                ...
                                <table class="table table-responsive">
									<tr>
                                        <td style="font-size:13px;" class="bg-dark-lt">
											<b>DIAGNOSA -> SIRKULASI -> RISIKO PENDARAHAN</b>
                                            <button class="btn btn-sm btn-primary btn-square" style="margin-left:840px;" onclick="saveDiagnosa()">
                                                Save
                                            </button>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Membran Mukosa Lembab</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="membran_mukosa_lembab">
                                                                ...
                                                                <label class="form-label">Kelembaban Kulit</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kelembaban_kulit">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kognitif">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Hemoptisis</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hemoptisis">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Hematemesis</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hematemesis">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Hematuria</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hematuria">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pendarahan Anus</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pendarahan_anus">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pendarahan Pervagina</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pendarahan_pervagina">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hemoglobin">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hematokrit">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var membran_mukosa_lembab = $("#membran_mukosa_lembab").val();
                var kelembaban_kulit = $("#kelembaban_kulit").val();
                var kognitif = $("#kognitif").val();
                var hemoptisis = $("#hemoptisis").val();
                var hematemesis = $("#hematemesis").val();
                var hematuria = $("#hematuria").val();
                var pendarahan_anus = $("#pendarahan_anus").val();
                var distensi_abdomen = $("#distensi_abdomen").val();
                var pendarahan_pervagina = $("#pendarahan_pervagina").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, membran_mukosa_lembab:membran_mukosa_lembab, kelembaban_kulit:kelembaban_kulit, 
                           kognitif:kognitif, hemoptisis:hemoptisis, hematemesis:hematemesis, hematuria:hematuria, pendarahan_anus:pendarahan_anus, 
                           distensi_abdomen:distensi_abdomen, pendarahan_pervagina:pendarahan_pervagina, hemoglobin:hemoglobin, 
                           hematokrit:hematokrit, tekanan_darah:tekanan_darah, frekuensi_nadi:frekuensi_nadi, 
                           suhu_tubuh:suhu_tubuh, master_form_diagnosa:master_form_diagnosa},
