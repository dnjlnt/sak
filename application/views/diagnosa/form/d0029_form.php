	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                            <label class="form-label">Perlekatan Bayi pada Payudara Ibu</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="perlekatan_bayi">
                                                                ...
                                                                <label class="form-label">Kemampuan Ibu Memposisikan Bayi dengan Benar</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_ibu">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Miksi Bayi Lebih Dari 8 Kali dalam 24 Jam</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="miksi_bayi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Berat Badan Bayi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="berat_badan_bayi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Tetesan/Pancaran ASI</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="tetesan_asi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Suplai ASI Adekuat</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="suplai_asi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Putting Tidak Lecet Setelah Dua Minggu Melahirkan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="putting_tidak_lecet">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kepercayaan Diri Ibu</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kepercayaan_diri_ibu">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Bayi Tidur Setelah Menyusu</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="bayi_tidur">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Payudara Ibu Kosong Setelah Menyusui</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="payudara_kosong">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Intake Bayi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="intake_bayi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Hisapan Bayi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hisapan_bayi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Lecet Pada Putting</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="lecet_putting">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Kelelahan Maternal</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kelelahan_maternal">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kecemasan Maternal</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kecemasan_maternal">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Bayi Rewel</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="bayi_rewel">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Bayi Menangis Setelah Menyusu</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="bayi_menangis">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var perlekatan_bayi = $("#perlekatan_bayi").val();
                var kemampuan_ibu = $("#kemampuan_ibu").val();
                var miksi_bayi = $("#miksi_bayi").val();
                var berat_badan_bayi = $("#berat_badan_bayi").val();
                var tetesan_asi = $("#tetesan_asi").val();
                var suplai_asi = $("#suplai_asi").val();
                var putting_tidak_lecet = $("#putting_tidak_lecet").val();
                var kepercayaan_diri_ibu = $("#kepercayaan_diri_ibu").val();
                var bayi_tidur = $("#bayi_tidur").val();
                var payudara_kosong = $("#payudara_kosong").val();
                var intake_bayi = $("#intake_bayi").val();
                var hisapan_bayi = $("#hisapan_bayi").val();
                var lecet_putting = $("#lecet_putting").val();
                var kelelahan_maternal = $("#kelelahan_maternal").val();
                var kecemasan_maternal = $("#kecemasan_maternal").val();
                var bayi_rewel = $("#bayi_rewel").val();
                var bayi_menangis = $("#bayi_menangis").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, perlekatan_bayi:perlekatan_bayi, kemampuan_ibu:kemampuan_ibu, miksi_bayi:miksi_bayi, 
                           berat_badan_bayi:berat_badan_bayi, tetesan_asi:tetesan_asi, suplai_asi:suplai_asi, 
                           putting_tidak_lecet:putting_tidak_lecet, kepercayaan_diri_ibu:kepercayaan_diri_ibu, bayi_tidur:bayi_tidur, 
                           payudara_kosong:payudara_kosong, intake_bayi:intake_bayi, hisapan_bayi:hisapan_bayi, lecet_putting:lecet_putting, 
                           kelelahan_maternal:kelelahan_maternal, kecemasan_maternal:kecemasan_maternal, bayi_rewel:bayi_rewel, 
                           bayi_menangis:bayi_menangis, master_form_diagnosa:master_form_diagnosa},
