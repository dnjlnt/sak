	...
	<body >
                                ...
                                <table class="table table-responsive">
									<tr>
                                        <td style="font-size:13px;" class="bg-dark-lt">
											<b>DIAGNOSA -> SIRKULASI -> RISIKO PERFUSI MIOKARD TIDAK EFEKTIF</b>
                                            <button class="btn btn-sm btn-primary btn-square" style="margin-left:715px;" onclick="saveDiagnosa()">
                                                Save
                                            </button>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <label class="form-label">Nyeri Dada</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="nyeri_dada">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Arteri Apikal</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="arteri_apikal">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Tekanan Darah Fraksi Ejeksi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="tekanan_darah_fraksi_ejeksi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Tekanan Baji Arteri Pulmonal</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="tekanan_baji_arteri_pulmonal">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var nyeri_dada = $("#nyeri_dada").val();
                var diaforesis = $("#diaforesis").val();
                var mual = $("#mual").val();
                var muntah = $("#muntah").val();
                var arteri_apikal = $("#arteri_apikal").val();
                ...
                var tekanan_darah_fraksi_ejeksi = $("#tekanan_darah_fraksi_ejeksi").val();
                var tekanan_baji_arteri_pulmonal = $("#tekanan_baji_arteri_pulmonal").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, ekg_aritmia:ekg_aritmia, nyeri_dada:nyeri_dada, diaforesis:diaforesis, mual:mual, 
                           muntah:muntah, arteri_apikal:arteri_apikal, tekanan_arteri:tekanan_arteri, takikardia:takikardia, 
                           bradikardia:bradikardia, denyut_nadi_radial:denyut_nadi_radial, tekanan_darah_fraksi_ejeksi:tekanan_darah_fraksi_ejeksi, 
                           tekanan_baji_arteri_pulmonal:tekanan_baji_arteri_pulmonal, cardiac_index:cardiac_index, 
