	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Kepuasan Hubungan Seksual</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kepuasan_hubungan">
                                                                ...
                                                                <label class="form-label">Mencari Informasi Untuk Mencari Kepuasan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="informasi_kepuasan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Aktivitas Seksual Berubah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="aktivitas_seks_berubah">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Eksistasi Seksual Berubah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="eksistasi_seks_berubah">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Peran Seksual Berubah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="peran_seks_berubah">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Fungsi Seksual Berubah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="fungsi_seks_berubah">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Keluhan Nyeri Saat Berhubungan Seksual (Dispareunia)</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="dispareunia">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Keluhan Hubungan Seksual Terbatas</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="keluhan_seks_terbatas">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Keluhan Sulit Melakukan Aktivitas Seksual</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="keluhan_sulit_seks">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Perilaku Seksual Berubah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="perilaku_seks_berubah">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Konflik Nilai</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="konflik_nilai">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Hasrat Seksual</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hasrat_seksual">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Orientasi Seksual</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="orientasi_seksual">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Ketertarikan Pada Pasangan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="ketertarikan_pasangan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var kepuasan_hubungan = $("#kepuasan_hubungan").val();
                var informasi_kepuasan = $("#informasi_kepuasan").val();
                var aktivitas_seks_berubah = $("#aktivitas_seks_berubah").val();
                var eksistasi_seks_berubah = $("#eksistasi_seks_berubah").val();
                var peran_seks_berubah = $("#peran_seks_berubah").val();
                var fungsi_seks_berubah = $("#fungsi_seks_berubah").val();
                var dispareunia = $("#dispareunia").val();
                var keluhan_seks_terbatas = $("#keluhan_seks_terbatas").val();
                var keluhan_sulit_seks = $("#keluhan_sulit_seks").val();
                var perilaku_seks_berubah = $("#perilaku_seks_berubah").val();
                var konflik_nilai = $("#konflik_nilai").val();
                var hasrat_seksual = $("#hasrat_seksual").val();
                var orientasi_seksual = $("#orientasi_seksual").val();
                var ketertarikan_pasangan = $("#ketertarikan_pasangan").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, kepuasan_hubungan:kepuasan_hubungan, informasi_kepuasan:informasi_kepuasan, 
                           aktivitas_seks_berubah:aktivitas_seks_berubah, eksistasi_seks_berubah:eksistasi_seks_berubah, 
                           peran_seks_berubah:peran_seks_berubah, fungsi_seks_berubah:fungsi_seks_berubah, dispareunia:dispareunia, 
                           keluhan_seks_terbatas:keluhan_seks_terbatas, keluhan_sulit_seks:keluhan_sulit_seks, 
                           perilaku_seks_berubah:perilaku_seks_berubah, konflik_nilai:konflik_nilai, hasrat_seksual:hasrat_seksual, 
                           orientasi_seksual:orientasi_seksual, ketertarikan_pasangan:ketertarikan_pasangan, 
