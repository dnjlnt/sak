	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Koordinasi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="koordinasi">
                                                                ...
                                                                <label class="form-label">Mengantuk</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="mengantuk">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pusing">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Lelah/Lesu</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Keluhan Lapar</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="keluhan_lapar">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Gemetar</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="gemetar">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="berkeringat">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Mulut Kering</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="mulut_kering">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="rasa_haus">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Perilaku Aneh</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="perilaku_aneh">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kesulitan Bicara</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kesulitan_bicara">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kadar Glukosa Dalam Darah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kadar_glukosa_darah">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Kadar Glukosa Dalam Urine</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kadar_glukosa_urine">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var koordinasi = $("#koordinasi").val();
                var kesadaran = $("#kesadaran").val();
                var mengantuk = $("#mengantuk").val();
                var pusing = $("#pusing").val();
                var lelah = $("#lelah").val();
                var keluhan_lapar = $("#keluhan_lapar").val();
                var gemetar = $("#gemetar").val();
                var berkeringat = $("#berkeringat").val();
                var mulut_kering = $("#mulut_kering").val();
                var rasa_haus = $("#rasa_haus").val();
                var perilaku_aneh = $("#perilaku_aneh").val();
                var kesulitan_bicara = $("#kesulitan_bicara").val();
                var kadar_glukosa_darah = $("#kadar_glukosa_darah").val();
                var kadar_glukosa_urine = $("#kadar_glukosa_urine").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, koordinasi:koordinasi, kesadaran:kesadaran, mengantuk:mengantuk, pusing:pusing, 
                           lelah:lelah, keluhan_lapar:keluhan_lapar, gemetar:gemetar, berkeringat:berkeringat, mulut_kering:mulut_kering, 
                           rasa_haus:rasa_haus, perilaku_aneh:perilaku_aneh, kesulitan_bicara:kesulitan_bicara, 
                           kadar_glukosa_darah:kadar_glukosa_darah, kadar_glukosa_urine:kadar_glukosa_urine, palpitasi:palpitasi, perilaku:perilaku, 
                           jumlah_urine:jumlah_urine, master_form_diagnosa:master_form_diagnosa},
