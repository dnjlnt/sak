	...
	<body >
                                ...
                                <table class="table table-responsive">
									<tr>
                                        <td style="font-size:13px;" class="bg-dark-lt">
											<b>DIAGNOSA -> RESPIRASI -> PENURUNAN CURAH JANTUNG</b>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="nadi_perifer">
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="olgouria">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label"><i>Pulmonary Vascular Resistance</i> (PVR)</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label"><i>Systemic Vascular Resistance</i> (SVR)</label>
                                                                <div id="select-luaran-intervensi-batuk">
        ...
        <script>
            function saveDiagnosa() {
                ...
                var nadi_perifer = $("#nadi_perifer").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, nadi_perifer:nadi_perifer, ejection_fraction:ejection_fraction, 
                           cardiac_index:cardiac_index, lvswi:lvswi, svi:svi, palpitasi:palpitasi, bradikardia:bradikardia, takikardia:takikardia, 
                           ekg_aritmia:ekg_aritmia, lelah:lelah, edema:edema, distensi_vena_jugularis:distensi_vena_jugularis, dispnea:dispnea, 
                           olgouria:olgouria, sianosis:sianosis, pnd:pnd, ortopnea:ortopnea, batuk:batuk, suara_jantung_s3:suara_jantung_s3, 
                           suara_jantung_s4:suara_jantung_s4, murmur_jantung:murmur_jantung, berat_badan:berat_badan, hepatomegali:hepatomegali, 
                           pvr:pvr, svr:svr, tekanan_darah:tekanan_darah, crt:crt, pawp:pawp, cvp:cvp, master_form_diagnosa:master_form_diagnosa},
