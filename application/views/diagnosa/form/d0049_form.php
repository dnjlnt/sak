	...
	<body >
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pengeluaran_feses">
                                                                ...
                                                                <label class="form-label">Konsistensi Feses</label>
                                                                <div id="select-luaran-intervensi-batuk">
        ...
        <script>
            function saveDiagnosa() {
                ...
                var pengeluaran_feses = $("#pengeluaran_feses").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, pengeluaran_feses:pengeluaran_feses, keluhan_defekasi:keluhan_defekasi, 
                           mengejan:mengejan, distensi_abdomen:distensi_abdomen, teraba_massa:teraba_massa, urgency:urgency, 
                           nyeri_abdomen:nyeri_abdomen, kram_abdomen:kram_abdomen, konsistensi_feses:konsistensi_feses, 
