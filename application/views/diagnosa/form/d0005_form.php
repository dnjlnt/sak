	...
	<body >
                                ...
                                <table class="table table-responsive">
									<tr>
                                        <td style="font-size:13px;" class="bg-dark-lt">
											<b>DIAGNOSA -> RESPIRASI -> POLA NAFAS TIDAK EFEKTIF</b>
                                            <button class="btn btn-sm btn-primary btn-square" style="margin-left:800px;" onclick="saveDiagnosa()">
                                                Save
                                            </button>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Ventilasi Semenit</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="ventilasi_semenit">
                                                                ...
                                                                <label class="form-label">Kapasitas Vital</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kapasitas_vital">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Diameter Throraks</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="diameter_throraks">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Anterior-posterior</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="anterior">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Tekanan Eksiprasi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="tekanan_ekspirasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Tekanan Inspirasi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="tekanan_inspirasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="otot_bantu_napas">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pemanjangan Fase Ekspirasi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="fase_ekspirasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pernapasan <i>Pursed</i>-lip</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pernapasan_pursed">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kedalaman napas</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kedalaman_nafas">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Ekskursi Dada</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="ekskursi_dada">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var ventilasi_semenit = $("#ventilasi_semenit").val();
                var kapasitas_vital = $("#kapasitas_vital").val();
                var diameter_throraks = $("#diameter_throraks").val();
                var anterior = $("#anterior").val();
                var tekanan_ekspirasi = $("#tekanan_ekspirasi").val();
                var tekanan_inspirasi = $("#tekanan_inspirasi").val();
                var dispnea = $("#dispnea").val();
                var otot_bantu_napas = $("#otot_bantu_napas").val();
                var fase_ekspirasi = $("#fase_ekspirasi").val();
                var ortopnea = $("#ortopnea").val();
                var pernapasan_pursed = $("#pernapasan_pursed").val();
                var frekuensi_nafas = $("#frekuensi_nafas").val();
                var kedalaman_nafas = $("#kedalaman_nafas").val();
                var ekskursi_dada = $("#ekskursi_dada").val();
                var master_form_diagnosa = $("#master_form_diagnosa").val();

                $.ajax({
                    type: "post",
                    url: "<?php echo base_url();?>d0005/savenewdiagnosa",
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, ventilasi_semenit:ventilasi_semenit, kapasitas_vital:kapasitas_vital, 
                           diameter_throraks:diameter_throraks, anterior:anterior, tekanan_ekspirasi:tekanan_ekspirasi, 
                           tekanan_inspirasi:tekanan_inspirasi, dispnea:dispnea, otot_bantu_napas:otot_bantu_napas, 
                           fase_ekspirasi:fase_ekspirasi, ortopnea:ortopnea, pernapasan_pursed:pernapasan_pursed, 
                           frekuensi_nafas:frekuensi_nafas, kedalaman_nafas:kedalaman_nafas, ekskursi_dada:ekskursi_dada, 
