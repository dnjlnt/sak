	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Verbalisasi Kebingungan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kebingungan">
                                                                ...
                                                                <label class="form-label">Verbalisasi Khawatir Akibat Kondisi yang Dihadapi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="khawatir">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Perilaku Gelisah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="perilaku_gelisah">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Perilaku Tegang</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="perilaku_tegang">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Keluhan Pusing</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="keluhan_pusing">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Frekuensi Pernafasan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="tremor">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Perasaan Keberdayaan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="perasaan_keberdayaan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kontak Mata</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kontak_mata">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pola Berkemih</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pola_berkemih">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var kebingungan = $("#kebingungan").val();
                var khawatir = $("#khawatir").val();
                var perilaku_gelisah = $("#perilaku_gelisah").val();
                var perilaku_tegang = $("#perilaku_tegang").val();
                var keluhan_pusing = $("#keluhan_pusing").val();
                ...
                var tremor = $("#tremor").val();
                var pucat = $("#pucat").val();
                var konsentrasi = $("#konsentrasi").val();
                var pola_tidur = $("#pola_tidur").val();
                var perasaan_keberdayaan = $("#perasaan_keberdayaan").val();
                var kontak_mata = $("#kontak_mata").val();
                var pola_berkemih = $("#pola_berkemih").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, selectedIntervensiUtama:selectedIntervensiUtama, selectedIntervensiPendukung:selectedIntervensiPendukung, durasi_intervensi:durasi_intervensi, kebingungan:kebingungan, khawatir:khawatir, perilaku_gelisah:perilaku_gelisah, perilaku_tegang:perilaku_tegang, keluhan_pusing:keluhan_pusing, anoreksia:anoreksia, palpitasi:palpitasi, frekuensi_nafas:frekuensi_nafas, frekuensi_nadi:frekuensi_nadi, tekanan_darah:tekanan_darah, diaforesis:diaforesis, tremor:tremor, pucat:pucat, konsentrasi:konsentrasi, pola_tidur:pola_tidur, perasaan_keberdayaan:perasaan_keberdayaan, kontak_mata:kontak_mata, pola_berkemih:pola_berkemih, orientasi:orientasi, master_form_diagnosa:master_form_diagnosa},
