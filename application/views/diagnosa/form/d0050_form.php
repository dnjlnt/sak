	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                            <label class="form-label">Sensasi Berkemih</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="sensasi_berkemih">
                                                                ...
                                                                <label class="form-label">Desakan Berkemih (Urgensi)</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="desakan_berkemih">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Distensi Kandung Kemih</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="distensi_kandung_kemih">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Berkemih Tidak Tuntas <i>(Hesitancy)</i></label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="berkemih_tidak_tuntas">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Volume Residu Urine</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="volume_residu_urine">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Urine Menetas <i>(Dribbling)</i></label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="urine_menetas">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Nokturia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="nokturia">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Mengompol</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="mengompol">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="disuria">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Anuria</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="anuria">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="frekuensi_bak">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Karakteristik Urine</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="karakteristik_urine">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var sensasi_berkemih = $("#sensasi_berkemih").val();
                var desakan_berkemih = $("#desakan_berkemih").val();
                var distensi_kandung_kemih = $("#distensi_kandung_kemih").val();
                var berkemih_tidak_tuntas = $("#berkemih_tidak_tuntas").val();
                var volume_residu_urine = $("#volume_residu_urine").val();
                var urine_menetas = $("#urine_menetas").val();
                var nokturia = $("#nokturia").val();
                var mengompol = $("#mengompol").val();
                var disuria = $("#disuria").val();
                var anuria = $("#anuria").val();
                var frekuensi_bak = $("#frekuensi_bak").val();
                var karakteristik_urine = $("#karakteristik_urine").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, sensasi_berkemih:sensasi_berkemih, desakan_berkemih:desakan_berkemih, 
                           distensi_kandung_kemih:distensi_kandung_kemih, berkemih_tidak_tuntas:berkemih_tidak_tuntas, 
                           volume_residu_urine:volume_residu_urine, urine_menetas:urine_menetas, nokturia:nokturia, mengompol:mengompol, 
                           disuria:disuria, anuria:anuria, frekuensi_bak:frekuensi_bak, karakteristik_urine:karakteristik_urine, 
