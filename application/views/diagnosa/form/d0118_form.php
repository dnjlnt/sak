	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Perasaan Nyaman Dengan Situasi Sosial</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="nyaman_situasi_sosial">
                                                                ...
                                                                <label class="form-label">Perasaan Mudah Menerima atau Mengkomunikasikan Perasaan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="mudah_menerima">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Responsif Pada Orang Lain</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="responsif">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Perasaan Tertarik Pada Orang Lain</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="perasaan_tertarik">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Minat Melakukan Kontak Emosi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="minat_kontak_emosi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Minat Melakukan Kontak Fisik</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="minat_kontak_fisik">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Kasih Sayang</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kasih_sayang">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Ekspresi Wajah Responsif</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="ekspresi_wajah">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kooperatif Dalam Bermain Dengan Sebaya</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kooperatif_bermain">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Perilaku Sesuai Usia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Gejala Cemas</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="gejala_cemas">
                                                                        <option value="0">Tidak Ada</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var nyaman_situasi_sosial = $("#nyaman_situasi_sosial").val();
                var mudah_menerima = $("#mudah_menerima").val();
                var responsif = $("#responsif").val();
                var perasaan_tertarik = $("#perasaan_tertarik").val();
                var minat_kontak_emosi = $("#minat_kontak_emosi").val();
                var minat_kontak_fisik = $("#minat_kontak_fisik").val();
                var kasih_sayang = $("#kasih_sayang").val();
                var kontak_mata = $("#kontak_mata").val();
                var ekspresi_wajah = $("#ekspresi_wajah").val();
                var kooperatif_bermain = $("#kooperatif_bermain").val();
                var perilaku_sesuai_usia = $("#perilaku_sesuai_usia").val();
                var gejala_cemas = $("#gejala_cemas").val();
                var master_form_diagnosa = $("#master_form_diagnosa").val();

                $.ajax({
                    type: "post",
                    url: "<?php echo base_url();?>diagnosa/savenewdiagnosa",
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, selectedIntervensiUtama:selectedIntervensiUtama, selectedIntervensiPendukung:selectedIntervensiPendukung, durasi_intervensi:durasi_intervensi, nyaman_situasi_sosial:nyaman_situasi_sosial, mudah_menerima:mudah_menerima, responsif:responsif, perasaan_tertarik:perasaan_tertarik, minat_kontak_emosi:minat_kontak_emosi, minat_kontak_fisik:minat_kontak_fisik, kasih_sayang:kasih_sayang, kontak_mata:kontak_mata, ekspresi_wajah:ekspresi_wajah, kooperatif_bermain:kooperatif_bermain, perilaku_sesuai_usia:perilaku_sesuai_usia, gejala_cemas:gejala_cemas, master_form_diagnosa:master_form_diagnosa},
