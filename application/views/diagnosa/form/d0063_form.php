	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Mempertahankan Makanan di Mulut</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="mempertahankan_makanan">
                                                                ...
                                                                <label class="form-label">Reflek Menelan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="reflek_menelan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kemampuan Mengosongkan Mulut</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="mengosongkan_mulut">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kemampuan Mengunyah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_mengunyah">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Usaha Menelan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="usaha_menelan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pembentukan Bolus</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pembentukan_bolus">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Frekuensi Tersedak</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="frekuensi_tersedak">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Refluks Lambung</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="refluks_lambung">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Produksi Saliva</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="produksi_saliva">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Penerimaan Makanan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="penerimaan_makanan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kualitas Suara</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kualitas_suara">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var mempertahankan_makanan = $("#mempertahankan_makanan").val();
                var reflek_menelan = $("#reflek_menelan").val();
                var mengosongkan_mulut = $("#mengosongkan_mulut").val();
                var kemampuan_mengunyah = $("#kemampuan_mengunyah").val();
                var usaha_menelan = $("#usaha_menelan").val();
                var pembentukan_bolus = $("#pembentukan_bolus").val();
                var frekuensi_tersedak = $("#frekuensi_tersedak").val();
                var batuk = $("#batuk").val();
                var muntah = $("#muntah").val();
                var refluks_lambung = $("#refluks_lambung").val();
                var gelisah = $("#gelisah").val();
                var regurgitasi = $("#regurgitasi").val();
                var produksi_saliva = $("#produksi_saliva").val();
                var penerimaan_makanan = $("#penerimaan_makanan").val();
                var kualitas_suara = $("#kualitas_suara").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, mempertahankan_makanan:mempertahankan_makanan, reflek_menelan:reflek_menelan, 
                           mengosongkan_mulut:mengosongkan_mulut, kemampuan_mengunyah:kemampuan_mengunyah, usaha_menelan:usaha_menelan, 
                           pembentukan_bolus:pembentukan_bolus, frekuensi_tersedak:frekuensi_tersedak, batuk:batuk, muntah:muntah, 
                           refluks_lambung:refluks_lambung, gelisah:gelisah, regurgitasi:regurgitasi, produksi_saliva:produksi_saliva, 
                           penerimaan_makanan:penerimaan_makanan, kualitas_suara:kualitas_suara, master_form_diagnosa:master_form_diagnosa},
