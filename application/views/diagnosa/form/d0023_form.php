	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Kekuatan Nadi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kekuatan_nadi">
                                                                ...
                                                                <label class="form-label">Output Urine</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="output_urine">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pengisian Vena</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pengisian_vena">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label"><i>Paroxysmal Nocturnal Dyspnea</i> (PND)</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Edema Anasarka</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="edema_anasarka">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="suara_nafas_tambahan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Konesti Paru</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="konesti_paru">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Keluhan Haus</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="keluhan_haus">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Konsentrasi Urine</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="konsentrasi_urine">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Tekanan Nadi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="tekanan_nadi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label"><i>Jugularis Vena Pressure</i> (JVP)</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="jugularis_vena_pressure">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kadar_hb">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kadar HT</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kadar_ht">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label"><i>Central Venous Pressure</i> (CVP)</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Refluks Hepatojugular</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="refluks_hepatojugular">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Berat Badan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="berat_badan_2">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Oligouria</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="oligouria">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Intake Cairan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="intake_cairan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="status_mental">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var kekuatan_nadi = $("#kekuatan_nadi").val();
                var turgor_kulit = $("#turgor_kulit").val();
                var output_urine = $("#output_urine").val();
                var pengisian_vena = $("#pengisian_vena").val();
                var ortopnea = $("#ortopnea").val();
                var dispnea = $("#dispnea").val();
                var pnd = $("#pnd").val();
                var edema_anasarka = $("#edema_anasarka").val();
                ...
                var suara_nafas_tambahan = $("#suara_nafas_tambahan").val();
                var konesti_paru = $("#konesti_paru").val();
                var perasaan_lemah = $("#perasaan_lemah").val();
                var keluhan_haus = $("#keluhan_haus").val();
                var konsentrasi_urine = $("#konsentrasi_urine").val();
                var frekuensi_nadi = $("#frekuensi_nadi").val();
                var tekanan_darah = $("#tekanan_darah").val();
                var tekanan_nadi = $("#tekanan_nadi").val();
                var membran_mukosa = $("#membran_mukosa").val();
                var jugularis_vena_pressure = $("#jugularis_vena_pressure").val();
                var kadar_hb = $("#kadar_hb").val();
                var kadar_ht = $("#kadar_ht").val();
                var cvp = $("#cvp").val();
                var refluks_hepatojugular = $("#refluks_hepatojugular").val();
                var berat_badan_2 = $("#berat_badan_2").val();
                var hepatomegali = $("#hepatomegali").val();
                var oligouria = $("#oligouria").val();
                var intake_cairan = $("#intake_cairan").val();
                var status_mental = $("#status_mental").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, kekuatan_nadi:kekuatan_nadi, turgor_kulit:turgor_kulit, output_urine:output_urine, 
                           pengisian_vena:pengisian_vena, ortopnea:ortopnea, dispnea:dispnea, pnd:pnd, edema_anasarka:edema_anasarka, 
                           edema_perifer:edema_perifer, berat_badan:berat_badan, distensi_vena_jugularis:distensi_vena_jugularis, 
                           suara_nafas_tambahan:suara_nafas_tambahan, konesti_paru:konesti_paru, perasaan_lemah:perasaan_lemah, 
                           keluhan_haus:keluhan_haus, konsentrasi_urine:konsentrasi_urine, frekuensi_nadi:frekuensi_nadi, 
                           tekanan_darah:tekanan_darah, tekanan_nadi:tekanan_nadi, membran_mukosa:membran_mukosa, jugularis_vena_pressure:jugularis_vena_pressure, 
                           kadar_hb:kadar_hb, kadar_ht:kadar_ht, cvp:cvp, refluks_hepatojugular:refluks_hepatojugular, berat_badan_2:berat_badan_2, 
                           hepatomegali:hepatomegali, oligouria:oligouria, intake_cairan:intake_cairan, status_mental:status_mental, 
