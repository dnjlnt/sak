	...
	<body >
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <label class="form-label">Nafsu Makan</label>
                                                                ...
                                                                <label class="form-label">Keluhan Mual</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="keluhan_mual">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Perasaan Ingin Muntah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="ingin_muntah">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Perasaan Asam Di Mulut</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="asam_mulut">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Sensasi Panas</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="sensasi_panas">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Sensasi Dingin</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="sensasi_dingin">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Frekuensi Menelan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="frekuensi_menelan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Diafroresis</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="diafroresis">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Jumlah Saliva</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="jumlah_saliva">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Dilatasi Pupil</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="dilatasi_pupil">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var keluhan_mual = $("#keluhan_mual").val();
                var ingin_muntah = $("#ingin_muntah").val();
                var asam_mulut = $("#asam_mulut").val();
                var sensasi_panas = $("#sensasi_panas").val();
                var sensasi_dingin = $("#sensasi_dingin").val();
                var frekuensi_menelan = $("#frekuensi_menelan").val();
                var diafroresis = $("#diafroresis").val();
                var jumlah_saliva = $("#jumlah_saliva").val();
                var pucat = $("#pucat").val();
                var takikardi = $("#takikardi").val();
                var dilatasi_pupil = $("#dilatasi_pupil").val();
                var master_form_diagnosa = $("#master_form_diagnosa").val();

                $.ajax({
                    type: "post",
                    url: "<?php echo base_url();?>diagnosa/savenewdiagnosa",
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, selectedIntervensiUtama:selectedIntervensiUtama, selectedIntervensiPendukung:selectedIntervensiPendukung, durasi_intervensi:durasi_intervensi, nafsu_makan:nafsu_makan, keluhan_mual:keluhan_mual, ingin_muntah:ingin_muntah, asam_mulut:asam_mulut, sensasi_panas:sensasi_panas, sensasi_dingin:sensasi_dingin, frekuensi_menelan:frekuensi_menelan, diafroresis:diafroresis, jumlah_saliva:jumlah_saliva, pucat:pucat, takikardi:takikardi, dilatasi_pupil:dilatasi_pupil, master_form_diagnosa:master_form_diagnosa},
