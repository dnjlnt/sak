	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                            <label class="form-label">Fungsi Kognitif</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="fungsi_kognitif">
                                                                ...
                                                                <label class="form-label">Aktivitas Psiko-motorik</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="aktivitas_psikomotorik">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Motivasi Memulai/Menyelesaikan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="motivasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Memori Jangka Pendek</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="memori_jangka_pendek">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Memori Jangka Panjang</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="memori_jangka_panjang">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="halusinasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="interpretasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Fungsi Sosial</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="fungsi_sosial">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Respon Terhadap Stimulus</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Persepsi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="persepsi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Fungsi Otak</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="fungsi_otak">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var fungsi_kognitif = $("#fungsi_kognitif").val();
                var tingkat_kesadaran = $("#tingkat_kesadaran").val();
                var aktivitas_psikomotorik = $("#aktivitas_psikomotorik").val();
                var motivasi = $("#motivasi").val();
                var memori_jangka_pendek = $("#memori_jangka_pendek").val();
                var memori_jangka_panjang = $("#memori_jangka_panjang").val();
                var halusinasi = $("#halusinasi").val();
                var gelisah = $("#gelisah").val();
                var interpretasi = $("#interpretasi").val();
                var fungsi_sosial = $("#fungsi_sosial").val();
                var respon_stimulus = $("#respon_stimulus").val();
                var persepsi = $("#persepsi").val();
                var fungsi_otak = $("#fungsi_otak").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, fungsi_kognitif:fungsi_kognitif, tingkat_kesadaran:tingkat_kesadaran, 
                           aktivitas_psikomotorik:aktivitas_psikomotorik, motivasi:motivasi, memori_jangka_pendek:memori_jangka_pendek, 
                           memori_jangka_panjang:memori_jangka_panjang, halusinasi:halusinasi, gelisah:gelisah, interpretasi:interpretasi, 
                           fungsi_sosial:fungsi_sosial, respon_stimulus:respon_stimulus, persepsi:persepsi, fungsi_otak:fungsi_otak, 
