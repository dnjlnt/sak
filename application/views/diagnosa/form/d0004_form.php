	...
	<body >
                                ...
                                <table class="table table-responsive">
									<tr>
                                        <td style="font-size:13px;" class="bg-dark-lt">
											<b>DIAGNOSA -> RESPIRASI -> GANGGUAN VENTILASI SPONTAN</b>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Volume Tidal</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="volume_tidal">
                                                                ...
                                                                <label class="form-label">SO<sub>2</sub></label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="so2">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var volume_tidal = $("#volume_tidal").val();
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url();?>d0004/savenewdiagnosa",
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, volume_tidal:volume_tidal, dispnea:dispnea, otot_bantu_nafas:otot_bantu_nafas, 
                           gelisah:gelisah, pco2:pco2, po2:po2, so2:so2, takikardia:takikardia, master_form_diagnosa:master_form_diagnosa},
