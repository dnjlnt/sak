	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Verbalisasi Kemampuan Mempelajari Hal Baru</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_mempelajar_hal_baru">
                                                                ...
                                                                <label class="form-label">Verbalisasi Kemampuan Mengingat Informasi Faktual</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_mengingat_informasi_faktual">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Kemampuan Mengingat Perilaku yang Pernah Dilakukan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_mengingat_perilaku">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Kemampuan Mengingat Peristiwa</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_mengingat_peristiwa">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Melakukan Kemampuan yang Dipelajari</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_dipelajari">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Pengalaman Lupa</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pengalaman_lupa">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Lupa Jadwal</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="lupa_jadwal">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Mudah Lupa</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="mudah_lupa">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var kemampuan_mempelajar_hal_baru = $("#kemampuan_mempelajar_hal_baru").val();
                var kemampuan_mengingat_informasi_faktual = $("#kemampuan_mengingat_informasi_faktual").val();
                var kemampuan_mengingat_perilaku = $("#kemampuan_mengingat_perilaku").val();
                var kemampuan_mengingat_peristiwa = $("#kemampuan_mengingat_peristiwa").val();
                var kemampuan_dipelajari = $("#kemampuan_dipelajari").val();
                var pengalaman_lupa = $("#pengalaman_lupa").val();
                var lupa_jadwal = $("#lupa_jadwal").val();
                var mudah_lupa = $("#mudah_lupa").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, kemampuan_mempelajar_hal_baru:kemampuan_mempelajar_hal_baru, 
                           kemampuan_mengingat_informasi_faktual:kemampuan_mengingat_informasi_faktual, 
                           kemampuan_mengingat_perilaku:kemampuan_mengingat_perilaku, kemampuan_mengingat_peristiwa:kemampuan_mengingat_peristiwa, 
                           kemampuan_dipelajari:kemampuan_dipelajari, pengalaman_lupa:pengalaman_lupa, lupa_jadwal:lupa_jadwal, 
                           mudah_lupa:mudah_lupa, master_form_diagnosa:master_form_diagnosa},
