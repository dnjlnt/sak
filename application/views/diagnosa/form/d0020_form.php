	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Kontrol Pengeluaran Feses</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kontrol_pengeluaran_feses">
                                                                ...
                                                                <label class="form-label">Keluhan Defekasi Lama dan Sulit</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="keluhan_defekasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Mengejan Saat Defekasi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="mengejan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Teraba Massa Pada Rektal</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="teraba_massa">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label"><i>Urgency</i></label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Kram Abdomen</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kram_abdomen">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Konsitensi Feses</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="konsistensi_feses">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Frekuensi Defekasi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="frekuensi_defekasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Peristaltik Usus</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="peristaltik_usus">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var kontrol_pengeluaran_feses = $("#kontrol_pengeluaran_feses").val();
                var keluhan_defekasi = $("#keluhan_defekasi").val();
                var mengejan = $("#mengejan").val();
                var distensi_abdomen = $("#distensi_abdomen").val();
                var teraba_massa = $("#teraba_massa").val();
                var urgency = $("#urgency").val();
                var nyeri_abdomen = $("#nyeri_abdomen").val();
                var kram_abdomen = $("#kram_abdomen").val();
                var konsistensi_feses = $("#konsistensi_feses").val();
                var frekuensi_defekasi = $("#frekuensi_defekasi").val();
                var peristaltik_usus = $("#peristaltik_usus").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, kontrol_pengeluaran_feses:kontrol_pengeluaran_feses, 
                           keluhan_defekasi:keluhan_defekasi, mengejan:mengejan, distensi_abdomen:distensi_abdomen, teraba_massa:teraba_massa, 
                           urgency:urgency, nyeri_abdomen:nyeri_abdomen, kram_abdomen:kram_abdomen, konsistensi_feses:konsistensi_feses, 
                           frekuensi_defekasi:frekuensi_defekasi, peristaltik_usus:peristaltik_usus, master_form_diagnosa:master_form_diagnosa},
