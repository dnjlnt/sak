	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Elastisitas</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="elastisitas">
                                                                ...
                                                                <label class="form-label">Hidrasi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hidrasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Perfusi Jaringan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="perfusi_jaringan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kerusakan Jaringan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kerusakan_jaringan">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Kerusakan Lapisan Kulit</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kerusakan_lapisan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pendarahan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hematoma">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pigmentasi Abnormal</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pigmentasi_abnormal">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Jaringan Perut</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="jaringan_perut">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Abrasi Kornea</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="abrasi_kornea">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="tekstur">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pertumbuhan Rambut</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pertumbuhan_rambut">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var elastisitas = $("#elastisitas").val();
                var hidrasi = $("#hidrasi").val();
                var perfusi_jaringan = $("#perfusi_jaringan").val();
                var kerusakan_jaringan = $("#kerusakan_jaringan").val();
                var kerusakan_lapisan = $("#kerusakan_lapisan").val();
                var nyeri = $("#nyeri").val();
                var pendarahan = $("#pendarahan").val();
                var kemerahan = $("#kemerahan").val();
                var hematoma = $("#hematoma").val();
                var pigmentasi_abnormal = $("#pigmentasi_abnormal").val();
                var jaringan_perut = $("#jaringan_perut").val();
                var nekrosis = $("#nekrosis").val();
                var abrasi_kornea = $("#abrasi_kornea").val();
                var suhu_kulit = $("#suhu_kulit").val();
                var sensasi = $("#sensasi").val();
                var tekstur = $("#tekstur").val();
                var pertumbuhan_rambut = $("#pertumbuhan_rambut").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, elastisitas:elastisitas, hidrasi:hidrasi, perfusi_jaringan:perfusi_jaringan, 
                           kerusakan_jaringan:kerusakan_jaringan, kerusakan_lapisan:kerusakan_lapisan, nyeri:nyeri, pendarahan:pendarahan, 
                           kemerahan:kemerahan, hematoma:hematoma, pigmentasi_abnormal:pigmentasi_abnormal, jaringan_perut:jaringan_perut, 
                           nekrosis:nekrosis, abrasi_kornea:abrasi_kornea, suhu_kulit:suhu_kulit, sensasi:sensasi, tekstur:tekstur, 
                           pertumbuhan_rambut:pertumbuhan_rambut, master_form_diagnosa:master_form_diagnosa},
