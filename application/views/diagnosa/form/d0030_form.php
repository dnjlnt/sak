                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <label class="form-label">Tebal Lipatan Kulit</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Index Massa Tubuh</label>
                                                                <div id="select-luaran-intervensi-batuk">
            ...
            function saveDiagnosa() {
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, berat_badan:berat_badan, tebal_lipatan_kulit:tebal_lipatan_kulit, 
                           index_massa_tubuh:index_massa_tubuh, master_form_diagnosa:master_form_diagnosa},
