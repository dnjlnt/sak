	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Kemampuan Mandi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_mandi">
                                                                ...
                                                                <label class="form-label">Kemampuan Menggunakan Pakaian</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_pakaian">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kemampuan Makan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_makan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kemampuan ke Toilet</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_toilet">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Keinginan Melakukan Perawatan Diri</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="perawatan_diri">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Minat Melakukan Perawatan Diri</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="minat_perawatan_diri">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Mempertahankan Kebersihan Diri</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kebersihan_diri">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Mempertahankan Kebersihan Mulut</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kebersihan_mulut">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var kemampuan_mandi = $("#kemampuan_mandi").val();
                var kemampuan_pakaian = $("#kemampuan_pakaian").val();
                var kemampuan_makan = $("#kemampuan_makan").val();
                var kemampuan_toilet = $("#kemampuan_toilet").val();
                var perawatan_diri = $("#perawatan_diri").val();
                var minat_perawatan_diri = $("#minat_perawatan_diri").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, selectedIntervensiUtama:selectedIntervensiUtama, selectedIntervensiPendukung:selectedIntervensiPendukung, durasi_intervensi:durasi_intervensi, kemampuan_mandi:kemampuan_mandi, kemampuan_pakaian:kemampuan_pakaian, kemampuan_makan:kemampuan_makan, kemampuan_toilet:kemampuan_toilet, perawatan_diri:perawatan_diri, minat_perawatan_diri:minat_perawatan_diri, kebersihan_diri:kebersihan_diri, kebersihan_mulut:kebersihan_mulut, master_form_diagnosa:master_form_diagnosa},
