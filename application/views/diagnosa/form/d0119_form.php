	...
	<body >
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_berbicara">
                                                                ...
                                                                <label class="form-label">Kemampuan Mendengar</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_mendengar">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kesesuaian Ekspresi Wajah/Tubuh</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kesesuaian_ekspresi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Afasia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="afasia">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Disfasia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="disfasia">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Apraksia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="apraksia">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Disleksia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="disleksia">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Disartria</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="disartria">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Afonia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="afonia">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Dislalia</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="dislalia">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pelo</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Gagap</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="gagap">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Respons Perilaku</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="repson_perilaku">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Pemahaman Komunikasi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pemahaman_komunikasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var kemampuan_berbicara = $("#kemampuan_berbicara").val();
                var kemampuan_mendengar = $("#kemampuan_mendengar").val();
                var kesesuaian_ekspresi = $("#kesesuaian_ekspresi").val();
                var kontak_mata = $("#kontak_mata").val();
                var afasia = $("#afasia").val();
                var disfasia = $("#disfasia").val();
                var apraksia = $("#apraksia").val();
                var disleksia = $("#disleksia").val();
                var disartria = $("#disartria").val();
                var afonia = $("#afonia").val();
                var dislalia = $("#dislalia").val();
                var pelo = $("#pelo").val();
                var gagap = $("#gagap").val();
                var repson_perilaku = $("#repson_perilaku").val();
                var pemahaman_komunikasi = $("#pemahaman_komunikasi").val();
                var master_form_diagnosa = $("#master_form_diagnosa").val();

                $.ajax({
                    type: "post",
                    url: "<?php echo base_url();?>diagnosa/savenewdiagnosa",
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, selectedIntervensiUtama:selectedIntervensiUtama, selectedIntervensiPendukung:selectedIntervensiPendukung, durasi_intervensi:durasi_intervensi, kemampuan_berbicara:kemampuan_berbicara, kemampuan_mendengar:kemampuan_mendengar, kesesuaian_ekspresi:kesesuaian_ekspresi, kontak_mata:kontak_mata, afasia:afasia, disfasia:disfasia, apraksia:apraksia, disleksia:disleksia, disartria:disartria, afonia:afonia, dislalia:dislalia, pelo:pelo, gagap:gagap, repson_perilaku:repson_perilaku, pemahaman_komunikasi:pemahaman_komunikasi, master_form_diagnosa:master_form_diagnosa},
