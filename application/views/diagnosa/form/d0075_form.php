	...
	<body >
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <label class="form-label">Luka Opilsiotomi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="luka_opilsiotomi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kontraksi_uterus">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Haemoroid</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="haemoroid">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Kontraksi Uterus</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kontraksi_uterus_2">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Payudara Membengkak</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="payudara_membengkak">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var luka_opilsiotomi = $("#luka_opilsiotomi").val();
                var kontraksi_uterus = $("#kontraksi_uterus").val();
                var berkeringat = $("#berkeringat").val();
                var menangis = $("#menangis").val();
                var merintih = $("#merintih").val();
                var haemoroid = $("#haemoroid").val();
                var kontraksi_uterus_2 = $("#kontraksi_uterus_2").val();
                var payudara_membengkak = $("#payudara_membengkak").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, selectedIntervensiUtama:selectedIntervensiUtama, selectedIntervensiPendukung:selectedIntervensiPendukung, durasi_intervensi:durasi_intervensi, tidak_nyaman:tidak_nyaman, meringis:meringis, luka_opilsiotomi:luka_opilsiotomi, kontraksi_uterus:kontraksi_uterus, berkeringat:berkeringat, menangis:menangis, merintih:merintih, haemoroid:haemoroid, kontraksi_uterus_2:kontraksi_uterus_2, payudara_membengkak:payudara_membengkak, tekanan_darah:tekanan_darah, frekuensi_nadi:frekuensi_nadi, master_form_diagnosa:master_form_diagnosa},
