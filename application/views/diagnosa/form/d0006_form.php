                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <label class="form-label">Kemampuan Menelan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kemampuan_menelan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Akumulasi Sekret</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="akumulasi_sekret">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="wheezing">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Penggunaan Otot Asesoris</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="otot_asesoris">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
            ...
            function saveDiagnosa() {
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, tingkat_kesadaran:tingkat_kesadaran, kemampuan_menelan:kemampuan_menelan, 
                           kebersihan_mulut:kebersihan_mulut, dispnea:dispnea, kelemahan_otot:kelemahan_otot, 
                           akumulasi_sekret:akumulasi_sekret, wheezing:wheezing, batuk:batuk, otot_asesoris:otot_asesoris, 
                           gelisah:gelisah, frekuensi_nafas:frekuensi_nafas, master_form_diagnosa:master_form_diagnosa},
