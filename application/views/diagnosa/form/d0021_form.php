	...
	<body >
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <label class="form-label">Regurgitasi</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="regurgitasi">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Suara Peristaltik</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="suara_peristaltik">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Pengosongan Lambung</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pengosongan_lambung">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Flatus</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="flatus">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var regurgitasi = $("#regurgitasi").val();
                var distensi_abdomen = $("#distensi_abdomen").val();
                var diare = $("#diare").val();
                var suara_peristaltik = $("#suara_peristaltik").val();
                var pengosongan_lambung = $("#pengosongan_lambung").val();
                var flatus = $("#flatus").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, nyeri:nyeri, kram_abdomen:kram_abdomen, mual:mual, muntah:muntah, 
                           regurgitasi:regurgitasi, distensi_abdomen:distensi_abdomen, diare:diare, suara_peristaltik:suara_peristaltik, 
                           pengosongan_lambung:pengosongan_lambung, flatus:flatus, konsistensi_feses:konsistensi_feses, 
