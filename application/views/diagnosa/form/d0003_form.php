	...
	<body >
                                ...
                                <table class="table table-responsive">
									<tr>
                                        <td style="font-size:13px;" class="bg-dark-lt">
											<b>DIAGNOSA -> RESPIRASI -> GANGGUAN PERTUKARAN GAS</b>
                                            <button class="btn btn-sm btn-primary btn-square" style="margin-left:780px;" onclick="saveDiagnosa()">
                                                Save
                                            </button>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <label class="form-label">Bunyi Nafas Tambahan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="bunyi_nafas_tambahan">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Penglihatan Kabur</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="penglihatan_kabur">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Napas Cuping Hidung</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="nafas_cuping_hidung">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pco2">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="po2">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">pH Arteri</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="ph_arteri">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="sianosis">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var bunyi_nafas_tambahan = $("#bunyi_nafas_tambahan").val();
                var pusing = $("#pusing").val();
                var penglihatan_kabur = $("#penglihatan_kabur").val();
                var diaforesis = $("#diaforesis").val();
                var gelisah = $("#gelisah").val();
                var nafas_cuping_hidung = $("#nafas_cuping_hidung").val();
                var pco2 = $("#pco2").val();
                var po2 = $("#po2").val();
                var takikardia = $("#takikardia").val();
                var ph_arteri = $("#ph_arteri").val();
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url();?>d0003/savenewdiagnosa",
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, tingkat_kesadaran:tingkat_kesadaran, dispnea:dispnea, 
                           bunyi_nafas_tambahan:bunyi_nafas_tambahan, pusing:pusing, penglihatan_kabur:penglihatan_kabur, diaforesis:diaforesis, 
                           dispnea:dispnea, gelisah:gelisah, nafas_cuping_hidung:nafas_cuping_hidung, pco2:pco2, po2:po2, takikardia:takikardia, 
                           ph_arteri:ph_arteri, sianosis:sianosis, pola_nafas:pola_nafas, warna_kulit:warna_kulit, 
