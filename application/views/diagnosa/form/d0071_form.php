	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Menunjukan Pendirian Seksual yang Jelas</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="pendirian_seks_jelas">
                                                                ...
                                                                <label class="form-label">Integrasi Orientasi Seksual Kedalam Kehidupan Sehari-hari</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="integrasi_orientasi_seks">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Menyusun Batasan-batasan Sesuai Jenis Kelamin</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="batasan_jenis_kelamin">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Pencarian Dukungan Sosial</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="dukungan_sosial">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Hubungan Harmonis</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hubungan_harmonis">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Verbalisasi Hubungan Seksual Sehat</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hubungan_seks_sehat">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var pendirian_seks_jelas = $("#pendirian_seks_jelas").val();
                var integrasi_orientasi_seks = $("#integrasi_orientasi_seks").val();
                var batasan_jenis_kelamin = $("#batasan_jenis_kelamin").val();
                var dukungan_sosial = $("#dukungan_sosial").val();
                var hubungan_harmonis = $("#hubungan_harmonis").val();
                var hubungan_seks_sehat = $("#hubungan_seks_sehat").val();

                $.ajax({
                    type: "post",
                    url: "<?php echo base_url();?>diagnosa/savenewdiagnosa",
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, selectedIntervensiUtama:selectedIntervensiUtama, selectedIntervensiPendukung:selectedIntervensiPendukung, durasi_intervensi:durasi_intervensi, pendirian_seks_jelas:pendirian_seks_jelas, integrasi_orientasi_seks:integrasi_orientasi_seks, batasan_jenis_kelamin:batasan_jenis_kelamin, dukungan_sosial:dukungan_sosial, hubungan_harmonis:hubungan_harmonis, hubungan_seks_sehat:hubungan_seks_sehat, master_form_diagnosa:master_form_diagnosa},
