	...
	<body >
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <label class="form-label">Tekanan Intra Kranial</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="tekanan_intra_kranial">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="sakit_kepala">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Nilai Rata-Rata Tekanan Darah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Refleks Sadar</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="refleks_sadar">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var tekanan_intra_kranial = $("#tekanan_intra_kranial").val();
                var sakit_kepala = $("#sakit_kepala").val();
                ...
                var refleks_sadar = $("#refleks_sadar").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, tingkat_kesadaran:tingkat_kesadaran, kognitif:kognitif, 
                           tekanan_intra_kranial:tekanan_intra_kranial, sakit_kepala:sakit_kepala, gelisah:gelisah, kecemasan:kecemasan, 
                           agitasi:agitasi, demam:demam, tekanan_darah:tekanan_darah, kesadaran:kesadaran, 
                           tekanan_darah_sistolik:tekanan_darah_sistolik, tekanan_darah_diastolik:tekanan_darah_diastolik, 
                           refleks_sadar:refleks_sadar, master_form_diagnosa:master_form_diagnosa},
