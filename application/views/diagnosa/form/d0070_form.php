	...
	<body >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label class="form-label">Kelekatan Emosional Dengan Janin</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kelekatan_emosional">
                                                                ...
                                                                <label class="form-label">Koping Dengan Ketidaknyamanan Kehamilan</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="koping">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Menurun</option>
                                                                        <option value="2">2. Cukup Menurun</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="nausea">
                                                                        <option value="0">Tidak Ada</option>
                                                                ...
                                                                <label class="form-label">Nyeri Epigastrik</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="nyeri_epigastrik">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label"><i>Mood</i> Labil</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="mood_labil">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="protein_urine">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="glukosa_urine">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Glukosa Darah</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                ...
                                                                <label class="form-label">Refleks Neurologis</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="refleks_neurologis">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Enzim Liver</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="enzim_liver">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Hitung Darah Lengkap</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="hitung_darah">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Status Kognitif</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="status_kognitif">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Memburuk</option>
                                                                        <option value="2">2. Cukup Memburuk</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var kelekatan_emosional = $("#kelekatan_emosional").val();
                var koping = $("#koping").val();
                var nausea = $("#nausea").val();
                var muntah = $("#muntah").val();
                var edema = $("#edema").val();
                var nyeri_abdomen = $("#nyeri_abdomen").val();
                var nyeri_epigastrik = $("#nyeri_epigastrik").val();
                var pendarahan = $("#pendarahan").val();
                var konstipasi = $("#konstipasi").val();
                var sakit_kepala = $("#sakit_kepala").val();
                var kejang = $("#kejang").val();
                var mood_labil = $("#mood_labil").val();
                var protein_urine = $("#protein_urine").val();
                var glukosa_urine = $("#glukosa_urine").val();
                ...
                var refleks_neurologis = $("#refleks_neurologis").val();
                var frekuensi_nadi = $("#frekuensi_nadi").val();
                var frekuensi_nafas = $("#frekuensi_nafas").val();
                var suhu_tubuh = $("#suhu_tubuh").val();
                var enzim_liver = $("#enzim_liver").val();
                var hitung_darah = $("#hitung_darah").val();
                var status_kognitif = $("#status_kognitif").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           durasi_intervensi:durasi_intervensi, kelekatan_emosional:kelekatan_emosional, koping:koping, nausea:nausea, 
                           muntah:muntah, edema:edema, nyeri_abdomen:nyeri_abdomen, nyeri_epigastrik:nyeri_epigastrik, pendarahan:pendarahan, 
                           konstipasi:konstipasi, sakit_kepala:sakit_kepala, kejang:kejang,  mood_labil:mood_labil, protein_urine:protein_urine, 
                           glukosa_urine:glukosa_urine, glukosa_darah:glukosa_darah, berat_badan:berat_badan, tekanan_darah:tekanan_darah, 
                           hemoglobin:hemoglobin, refleks_neurologis:refleks_neurologis, frekuensi_nadi:frekuensi_nadi, 
                           frekuensi_nafas:frekuensi_nafas, suhu_tubuh:suhu_tubuh, enzim_liver:enzim_liver, hitung_darah:hitung_darah, 
                           status_kognitif:status_kognitif, master_form_diagnosa:master_form_diagnosa},
