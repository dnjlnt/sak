	...
	<body >
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="kerusakan_lapisan_kulit">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
                                                                ...
                                                                <label class="form-label">Jaringan Parut</label>
                                                                <div id="select-luaran-intervensi-batuk">
                                                                    <select class="form-control" id="jaringan_parut">
                                                                        <option value="0">Tidak Ada</option>
                                                                        <option value="1">1. Meningkat</option>
                                                                        <option value="2">2. Cukup Meningkat</option>
                                                                        <option value="3">3. Sedang</option>
        ...
        <script>
            function saveDiagnosa() {
                ...
                var kerusakan_lapisan_kulit = $("#kerusakan_lapisan_kulit").val();
                var nyeri = $("#nyeri").val();
                ...
                var jaringan_parut = $("#jaringan_parut").val();
                ...
                $.ajax({
                    ...
                    data: {selectedDiagnosaGejalaMayor:selectedDiagnosaGejalaMayor, selectedDiagnosa:selectedDiagnosa, 
                           ...
                           kerusakan_jaringan:kerusakan_jaringan, kerusakan_lapisan_kulit:kerusakan_lapisan_kulit, nyeri:nyeri, 
                           pendarahan:pendarahan, kemerahan:kemerahan, hematoma:hematoma, pigmentasi_abnormal:pigmentasi_abnormal, 
                           jaringan_parut:jaringan_parut, nekrosis:nekrosis, abrasi_kornea:abrasi_kornea, suhu_kulit:suhu_kulit, sensasi:sensasi, 
                           tekstur:tekstur, pertumbuhan_rambut:pertumbuhan_rambut, master_form_diagnosa:master_form_diagnosa},
