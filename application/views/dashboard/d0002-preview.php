                        ...
                        <div class="col-md-12">
                            <table class="table table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:10px;border:none;">
                                        <center>
                                            <b>D. 0002 - Gangguan Penyapihan Ventilator</b>
                                            <br>
                                            <b>Definisi:</b> 
                                ...
                                <tbody>
                                    <tr style="font-size:11px;width:200px;">
                                        ...
                                        <td class="no-border" style="width:300px;">
                                            <?php
                                                $sql = "select * from t_diagnosa_keperawatan where diagnosa_form_id = 'D0002'";
                                        ...
                                        <td class="no-border">
                                            ...
                                            <table class="table">
                                                <tr>
                                                    <td class="no-border" style="width:200px;">Kesinkronan Bantuan Ventilator</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-border">Penggunaan Otot Bantu Nafas</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-border">Nafas Megap-Megap (Gasping)</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-border">Nafas Dangkal</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-border">Agitasi</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-border">Lelah</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-border">Perasaan Kuatir Mesin Rusak</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-border">Fokus Pada Pernafasan</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-border">Napas Paradoks Abdominal</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="no-border">Nilai Gas Darah Arteri</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-border">Upaya Nafas</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-border">Auskultasi Suara Inspirasi</td>
                                                    <td class="no-border" colspan="5">: <b>-</b></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <td class="no-border">
                                            ...
                                            <br><br>
                                            <?php
                                                $sql = "select * from t_intervensi_keperawatan where diagnosa_form_id = 'D0002' 
                                            ...
                                            <?php
                                                ...
                                                if ($query->num_rows() > 0) {
                                                   foreach ($query->result() as $row) {
                                                        ...
                                                        $c = "";
                                                        $sql = "select * from t_diag_record where diag_master_record_id = 'D0002'";
                                                        $query = $this->db->query($sql);
                                                        if ($query->num_rows() > 0) {
