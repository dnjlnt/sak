                                ...
                                <table class="table table-responsive">
									<tr>
                                        <td style="font-size:13px;" class="bg-dark-lt">
											<b>DIAGNOSA - SUB KATEGORI AKTIVITAS DAN ISTIRAHAT</b>
                                    ...
                                    <tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/respirasi">D. 0054. Gangguan Mobilitas Fisik</a>
										</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/sirkulasi">D. 0055. Gangguan Pola Tidur</a>
										</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/nutrisicairan">D. 0056. Intoleransi Aktivitas</a>
										</td>
                                    </tr>
                                </table>
                            </div>
