                                ...
                                <table class="table table-responsive">
									<tr>
                                        <td style="font-size:13px;" class="bg-dark-lt">
											<b>INTERVENSI PENDUKUNG</b>
										</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/respirasi">Respirasi</a>
										</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/sirkulasi">Sirkulasi</a>
										</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/nutrisicairan">Nutrisi dan Cairan</a>
										</td>
                                    </tr>
									<tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/eliminasi">Eliminasi</a>
										</td>
                                    </tr>
									<tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/aktivitasistirahat">Aktivitas dan Istirahat</a>
										</td>
                                    </tr>
									<tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/neurosensori">Neurosensori</a>
										</td>
                                    </tr>
									<tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/reproduksiseksualitas">Reproduksi dan Seksualitas</a>
										</td>
                                    </tr>
									<tr>
                                        <td style="font-size:12px;">
											<a href="<?php echo base_url();?>dashboard/nyerikenyamanan">Nyeri dan Kenyamanan</a>
										</td>
                                    </tr>
									<tr>
                                        <td style="font-size:12px;">
