                        ...
                        <div class="col-md-12">
                            <table class="table table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:10px;border:none;">
                                        <center>
                                            <b>D. 0027 - Ketidakstabilan Kadar Glukosa Darah</b>
                                            <br>
                                            <b>Definisi:</b> 
                            ...
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                    <tr style="font-size:11px;width:200px;">
                                        ...
                                        <td class="no-border">
                                            Setelah dilakukan intervensi keperawatan selama <b><u><?php echo $int_duration; ?></u></b> jam, kadar glukosa darah berada pada rentang normal <b>meningkat</b>, 
