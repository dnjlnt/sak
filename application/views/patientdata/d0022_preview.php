                        ...
                        <div class="col-md-12">
                            <table class="table table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:10px;border:none;">
                                        <center>
                                            <b>D. 0022 - Hipervolemia</b>
                                            <br>
                                            <b>Definisi:</b> 
                                            Peningkatan volume cairan intravaskuler, interstisial, dan/atau intraselluler.
                                        </center>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                    <tr style="font-size:11px;width:200px;">
                                        ...
                                        <td class="no-border">
                                            Setelah dilakukan intervensi keperawatan selama <b><u><?php echo $int_duration; ?></u></b> jam, keseimbangan antara volume cairan intraselluler dan ekstraseslluler <b>meningkat</b>, 
