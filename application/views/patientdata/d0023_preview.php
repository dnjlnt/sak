                        ...
                        <div class="col-md-12">
                            <table class="table table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:10px;border:none;">
                                        <center>
                                            <b>D. 0023 - Hipovolemia</b>
                                            <br>
                                            <b>Definisi:</b> 
                                            Penurunan volume cairan intravaskuler, interstisial dan/atau intraselluler.
                                        </center>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                    <tr style="font-size:11px;width:200px;">
                                        ...
                                        <td class="no-border">
                                            Setelah dilakukan intervensi keperawatan selama <b><u><?php echo $int_duration; ?></u></b> jam, kondisi volume cairan intravaskuler, interstisial dan/atau intraseluler <b>membaik</b>, 
