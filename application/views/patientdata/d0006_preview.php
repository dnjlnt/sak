                        ...
                        <div class="col-md-12">
                            <table class="table table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:10px;border:none;">
                                        <center>
                                            <b>D. 0006 - Risiko Aspirasi</b>
                                            <br>
                                            <b>Definisi:</b> 
                                            Resiko mengalami masuknya sekresi gastrointestonal, sekresi orofaring, benda cair atau padat ke dalam saluran napas. trakeobronkhial akibat disfungsi mekanisme protektif saluran.
                                        </center>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                    <tr style="font-size:11px;width:200px;">
                                        ...
                                        <td class="no-border">
                                            Setelah dilakukan intervensi keperawatan selama <b><u><?php echo $int_duration; ?></u></b> jam, risiko aspirasi <b>menurun</b>, 
